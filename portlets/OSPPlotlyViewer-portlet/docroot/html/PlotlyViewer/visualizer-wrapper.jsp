...
<div class="container-fluid osp-visualizer">
	...
	<div class="row-fluid osp-frame">
		<iframe 
				...
				src="<%=request.getContextPath()%>/html/PlotlyViewer/inner-viewer.jsp">
		</iframe>
	</div>
</div>
 ...
 ***********************************************************************/
 ...
 var <portlet:namespace/>config = {
			...
			loadCanvas: <portlet:namespace/>loadOneD,
			procFuncs:{
 ...
 * Canvas functions
 ***********************************************************************/
function <portlet:namespace/>loadOneD( jsonData, changeAlert ){
	...
	case OSP.Enumeration.PathType.FILE_CONTENT:
		...
		<portlet:namespace/>visualizer.callIframeFunc( 'loadPly', null, jsonData.content_, '', '' );
		break;
