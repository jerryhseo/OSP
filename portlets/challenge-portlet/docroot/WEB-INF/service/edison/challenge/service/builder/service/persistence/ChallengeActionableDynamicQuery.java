 ...
 * @generated
 */
public abstract class ChallengeActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public ChallengeActionableDynamicQuery() throws SystemException {
		setBaseLocalService(ChallengeLocalServiceUtil.getService());
		setClass(Challenge.class);

		setClassLoader(edison.challenge.service.builder.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("challengeid");
	}
}