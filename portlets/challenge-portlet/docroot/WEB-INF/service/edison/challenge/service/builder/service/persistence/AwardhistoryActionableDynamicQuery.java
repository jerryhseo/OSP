 ...
 * @generated
 */
public abstract class AwardhistoryActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public AwardhistoryActionableDynamicQuery() throws SystemException {
		setBaseLocalService(AwardhistoryLocalServiceUtil.getService());
		setClass(Awardhistory.class);

		setClassLoader(edison.challenge.service.builder.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("awardhistoryid");
	}
}