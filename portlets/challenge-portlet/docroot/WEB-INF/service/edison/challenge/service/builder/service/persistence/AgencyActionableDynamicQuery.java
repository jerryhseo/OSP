 ...
 * @generated
 */
public abstract class AgencyActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public AgencyActionableDynamicQuery() throws SystemException {
		setBaseLocalService(AgencyLocalServiceUtil.getService());
		setClass(Agency.class);

		setClassLoader(edison.challenge.service.builder.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("agencyid");
	}
}