...
import edison.challenge.service.builder.service.AgencyLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link edison.challenge.service.builder.service.impl.AgencyLocalServiceImpl}.
 * </p>
 *
 * @author kyj
...
public abstract class AgencyLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements AgencyLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link edison.challenge.service.builder.service.AgencyLocalServiceUtil} to access the agency local service.
	 */
	 ...
	 */
	@Override
	public Agency createAgency(long agencyid) {
	...
	public Agency deleteAgency(long agencyid)
		...
		return agencyPersistence.remove(agencyid);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Agency deleteAgency(Agency agency) throws SystemException {
	...
	@Override
	public Agency fetchAgency(long agencyid) throws SystemException {
		return agencyPersistence.fetchByPrimaryKey(agencyid);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("edison.challenge.service.builder.model.Agency",
			agencyLocalService);
	}
	...
	private AgencyLocalServiceClpInvoker _clpInvoker = new AgencyLocalServiceClpInvoker();
}