...
import edison.challenge.service.builder.service.AwardhistoryService;
...
/**
 * Provides the base implementation for the awardhistory remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link edison.challenge.service.builder.service.impl.AwardhistoryServiceImpl}.
 * </p>
 *
 * @author kyj
 ...
 * @generated
 */
public abstract class AwardhistoryServiceBaseImpl extends BaseServiceImpl
	implements AwardhistoryService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link edison.challenge.service.builder.service.AwardhistoryServiceUtil} to access the awardhistory remote service.
	 */
	...
	private AwardhistoryServiceClpInvoker _clpInvoker = new AwardhistoryServiceClpInvoker();
}