    ...
    createClass(EditToolbar, [{
        ...
        value: function render() {
            ...
            if (this.props.dom._tree.config.editing.edit) {
                buttons.push(createVNode$1(2, 'a', 'btn icon icon-pencil', null, {
            ...
            if (this.props.dom._tree.config.editing.add) {
                buttons.push(createVNode$1(2, 'a', 'btn icon icon-plus', null, {
            ...
            if (this.props.dom._tree.config.editing.remove) {
                buttons.push(createVNode$1(2, 'a', 'btn icon icon-minus', null, {
                    'onclick': this.remove.bind(this),
                    'title': 'Remove this node'
                }));
            }

            return createVNode$1(2, 'span', 'btn-group', buttons);
        }
    }]);
    return EditToolbar;
}(infernoComponent);
...
var EmptyList = function (_Component) {
    ...
    createClass(EmptyList, [{
        key: 'render',
        value: function render() {
            return createVNode$2(2, 'ol', null, createVNode$2(2, 'li', 'leaf', createVNode$2(2, 'span', 'title icon icon-file-empty empty', this.props.text)));
        }
    }]);
    return EmptyList;
}(infernoComponent);
...
var EditForm = function (_Component) {
    ...
    createClass(EditForm, [{
        ...
        value: function render() {
            ...
            return createVNode$3(2, 'form', null, [createVNode$3(512, 'input', null, null, {
            ...
            }), createVNode$3(2, 'span', 'btn-group', [createVNode$3(2, 'button', 'btn icon icon-check', null, {
                'onClick': this.save.bind(this),
                'title': 'Save',
                'type': 'button'
            }), createVNode$3(2, 'button', 'btn icon icon-cross', null, {
...
var NodeAnchor = function (_Component) {
    ...
    createClass(NodeAnchor, [{
        ...
        value: function render() {
            ...
            if (node.editing()) {
                content = createVNode$4(16, EditForm, null, null, {
                    'dom': this.props.dom,
                    'node': this.props.node
                });
            }

            return createVNode$4(2, 'a', null, content, _extends({
                'data-uid': node.id,
...
var ToggleAnchor = function (_Component) {
    ...
    createClass(ToggleAnchor, [{
        ...
        key: 'render',
        value: function render() {
            return createVNode$5(2, 'a', this.className(), null, {
...
var ListItem = function (_Component) {
    ...
    createClass(ListItem, [{
        ...
        value: function renderCheckbox() {
            ...
            if (this.props.dom.config.showCheckboxes) {
                return createVNode$6(16, Checkbox, null, null, {
        ...
        value: function renderChildren() {
            ...
            if (node.hasChildren()) {
                ...
                return createVNode$6(16, List, null, null, {
                    'context': node,
                    'dom': dom,
                ...
                if (!node.hasLoadedChildren()) {
                    return createVNode$6(16, EmptyList, null, null, {
                        'text': 'Loading...'
                    });
                } else {
                    return createVNode$6(16, EmptyList, null, null, {
        ...
        value: function renderEditToolbar() {
            ...
            if (this.props.dom._tree.config.editing.edit && !this.props.node.editing()) {
                return createVNode$6(16, EditToolbar, null, null, {
                    'dom': this.props.dom,
                    'node': this.props.node
                });
            }
        ...
        value: function renderToggle() {
            ...
            if (hasVisibleChildren) {
                return createVNode$6(16, ToggleAnchor, null, null, {
        ...
        value: function render() {
            ...
            var li = createVNode$6(2, 'li', null, [this.renderEditToolbar(), createVNode$6(2, 'div', 'title-wrap', [this.renderToggle(), this.renderCheckbox(), createVNode$6(16, NodeAnchor, null, null, {
                'dom': this.props.dom,
                ...
                'node': node,
                'text': node.text
            })]), createVNode$6(2, 'div', 'wholerow'), this.renderChildren()], _extends({}, this.getAttributes()), null, function (elem) {
...
var List = function (_Component) {
    ...
    createClass(List, [{
        ...
        value: function renderLoadMoreNode() {
            return createVNode$7(2, 'li', 'leaf detached', createVNode$7(2, 'a', 'title icon icon-more load-more', 'Load More', {
        ...
        value: function renderLoadingTextNode() {
            return createVNode$7(2, 'li', 'leaf', createVNode$7(2, 'span', 'title icon icon-more', 'Loading...'));
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            var items = _.map(renderNodes, function (node) {
                return createVNode$7(16, ListItem, null, null, {
            ...
            return createVNode$7(2, 'ol', null, [items, this.props.children]);
        }
    }]);
    return List;
}(infernoComponent);
...
var Tree = function (_Component) {
    ...
    createClass(Tree, [{
        ...
        value: function renderAddLink() {
            if (this.props.dom._tree.config.editing.add) {
                return createVNode$8(2, 'li', null, createVNode$8(2, 'a', 'btn icon icon-plus', null, {
                    'onClick': this.add.bind(this),
        ...
        value: function render() {
            ...
            return createVNode$8(16, List, null, null, {
                'dom': dom,
                'limit': pagination.limit,
                'loading': loading,
                'nodes': nodes,
...
var InspireDOM = function () {
    ...
    createClass(InspireDOM, [{
        ...
        value: function renderNodes(nodes) {
            inferno_1(createVNode$9(16, Tree, null, null, {
                'dom': this,
