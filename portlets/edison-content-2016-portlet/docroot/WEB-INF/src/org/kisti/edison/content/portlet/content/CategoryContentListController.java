...
@Controller
@RequestMapping("VIEW")
public class CategoryContentListController{

	private static Log log = LogFactoryUtil.getLog(CategoryContentListController.class);
	...
	public String view(RenderRequest request, ModelMap model){
		...
		try{
			...
			if(tabViewYn.equals("Y")){
				...
				model.addAttribute("visitSite", CustomUtil.strNull(param.get("groupId"), Long.toString(GroupLocalServiceUtil.getGroup(companyId, visitSite).getGroupId())));
			}
