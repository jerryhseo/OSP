...
public class StatisticsController {
	...
	public void getStatisticsContent(ResourceRequest request, ResourceResponse response) throws IOException, SystemException, JSONException{
		Map params = RequestUtil.getParameterMap(request);
			...
			obj.put("pieChartOrganigationList", null);
	...
	public void retrieveListGeneral(ResourceRequest request, ResourceResponse response){
		try{
			...
			List<Map<String, Object>> dataList = null;//GeneralContentLocalServiceUtil.getGeneralContentStsList(groupId, contentDiv, start, listSize*currentPage, themeDisplay.getLocale());
			int totalCount = 0;//GeneralContentLocalServiceUtil.getGeneralContentCountByGroupId(groupId, contentDiv, "",themeDisplay.getLocale());
	...
	public void excelDown(ResourceRequest request, ResourceResponse response){
		...
		try {		
			...
			int total = 0;//GeneralContentLocalServiceUtil.getGeneralContentCountByGroupId(groupId, contentDiv, "", themeDisplay.getLocale());
			List tableOrganigationList  = null;//GeneralContentLocalServiceUtil.getGeneralContentStsList(groupId, contentDiv, 0, total, themeDisplay.getLocale());
