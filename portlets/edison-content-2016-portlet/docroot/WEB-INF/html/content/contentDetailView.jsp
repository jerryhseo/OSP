...
<%-- 	<aui:input type="hidden" name="mode" value=""/> --%>
	...
	<c:if test="${isOwner == true || isManager == true}"> 
		<div class="topvisualbtnbox">&nbsp;<input type="button" value="<liferay-ui:message key='edison-virtuallab-scienceapp-management'/>" class="btn_blueb topbtn" onclick="<portlet:namespace/>updateContent('<%=Constants.UPDATE%>');" /></div>
	</c:if>
