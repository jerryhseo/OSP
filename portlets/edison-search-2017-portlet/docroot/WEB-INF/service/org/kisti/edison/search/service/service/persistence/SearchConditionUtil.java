...
/**
 * The persistence utility for the search condition service. This utility wraps {@link SearchConditionPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class SearchConditionUtil {
	 ...
	 */
	public static void clearCache(SearchCondition searchCondition) {
		getPersistence().clearCache(searchCondition);
	}
	 ...
	 */
	public static List<SearchCondition> findWithDynamicQuery(
	 ...
	 */
	public static SearchCondition update(SearchCondition searchCondition)
		throws SystemException {
		return getPersistence().update(searchCondition);
	}
	...
	public static SearchCondition update(SearchCondition searchCondition,
		...
		return getPersistence().update(searchCondition, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(searchCondition);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(searchConditions);
	}
	...
	*/
	public static org.kisti.edison.search.service.model.SearchCondition create(
		long id) {
	...
	*/
	public static org.kisti.edison.search.service.model.SearchCondition remove(
		long id)
	...
	public static org.kisti.edison.search.service.model.SearchCondition updateImpl(
		org.kisti.edison.search.service.model.SearchCondition searchCondition)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(searchCondition);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static org.kisti.edison.search.service.model.SearchCondition findByPrimaryKey(
		long id)
		throws com.liferay.portal.kernel.exception.SystemException,
			org.kisti.edison.search.service.NoSuchSearchConditionException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static org.kisti.edison.search.service.model.SearchCondition fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<org.kisti.edison.search.service.model.SearchCondition> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static SearchConditionPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (SearchConditionPersistence)PortletBeanLocatorUtil.locate(org.kisti.edison.search.service.service.ClpSerializer.getServletContextName(),
					SearchConditionPersistence.class.getName());

			ReferenceRegistry.registerReference(SearchConditionUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(SearchConditionPersistence persistence) {
	}

	private static SearchConditionPersistence _persistence;
}