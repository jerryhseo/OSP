...
/**
 * Provides the local service interface for SearchCondition. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author yjpark
 * @see SearchConditionLocalServiceUtil
...
public interface SearchConditionLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SearchConditionLocalServiceUtil} to access the search condition local service. Add custom service methods to {@link org.kisti.edison.search.service.service.impl.SearchConditionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
