package com.kisti.osp.analyzer.portlet.jsmol;
...
/**
 * Portlet implementation class OSPJSMolPortlet
 */
public class OSPJSMolPortlet extends MVCPortlet {
    private static Log _log = LogFactoryUtil.getLog(OSPJSMolPortlet.class);
