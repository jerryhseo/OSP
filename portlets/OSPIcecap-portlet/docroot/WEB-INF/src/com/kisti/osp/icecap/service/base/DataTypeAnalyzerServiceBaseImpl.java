...
import com.kisti.osp.icecap.service.DataTypeAnalyzerService;
...
/**
 * Provides the base implementation for the data type analyzer remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.kisti.osp.icecap.service.impl.DataTypeAnalyzerServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class DataTypeAnalyzerServiceBaseImpl extends BaseServiceImpl
	implements DataTypeAnalyzerService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.kisti.osp.icecap.service.DataTypeAnalyzerServiceUtil} to access the data type analyzer remote service.
	 */
	...
	private DataTypeAnalyzerServiceClpInvoker _clpInvoker = new DataTypeAnalyzerServiceClpInvoker();
}