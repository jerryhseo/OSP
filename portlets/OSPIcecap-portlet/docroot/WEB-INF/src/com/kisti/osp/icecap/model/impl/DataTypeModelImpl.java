...
import com.kisti.osp.icecap.model.DataTypeModel;
import com.kisti.osp.icecap.model.DataTypeSoap;
 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link com.kisti.osp.icecap.model.DataTypeModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link DataTypeImpl}.
 * </p>
 *
 * @author Young-K. Suh and Jerry H. Seo
 * @see DataTypeImpl
 * @see com.kisti.osp.icecap.model.DataType
 * @see com.kisti.osp.icecap.model.DataTypeModel
 * @generated
 */
@JSON(strict = true)
public class DataTypeModelImpl extends BaseModelImpl<DataType>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a data type model instance should use the {@link com.kisti.osp.icecap.model.DataType} interface instead.
	 */
	...
	public static final String TABLE_SQL_CREATE = "create table icecap_DataType (uuid_ VARCHAR(75) null,typeId LONG not null primary key,name VARCHAR(75) null,version VARCHAR(75) null,companyId LONG,userId LONG,createDate DATE null,modifiedDate DATE null,samplePath VARCHAR(75) null,status INTEGER,description STRING null,groupId LONG,isFavorite BOOLEAN,ownerId LONG)";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.kisti.osp.icecap.model.DataType"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.kisti.osp.icecap.model.DataType"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.kisti.osp.icecap.model.DataType"),
			true);
	public static long COMPANYID_COLUMN_BITMASK = 1L;
	public static long GROUPID_COLUMN_BITMASK = 2L;
	public static long ISFAVORITE_COLUMN_BITMASK = 4L;
	...
	public static DataType toModel(DataTypeSoap soapModel) {
		...
		model.setIsFavorite(soapModel.getIsFavorite());
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.kisti.osp.icecap.model.DataType"));
	...
	public void setIsFavorite(boolean isFavorite) {
		_columnBitmask |= ISFAVORITE_COLUMN_BITMASK;

		if (!_setOriginalIsFavorite) {
			_setOriginalIsFavorite = true;
	...
	public boolean getOriginalIsFavorite() {
		return _originalIsFavorite;
	}
	...
	public Object clone() {
		...
		dataTypeImpl.setIsFavorite(getIsFavorite());
		dataTypeImpl.setOwnerId(getOwnerId());
	...
	public void resetOriginalValues() {
		...
		dataTypeModelImpl._originalTypeId = dataTypeModelImpl._typeId;

		dataTypeModelImpl._setOriginalTypeId = false;
		...
		dataTypeModelImpl._originalIsFavorite = dataTypeModelImpl._isFavorite;

		dataTypeModelImpl._setOriginalIsFavorite = false;

		dataTypeModelImpl._originalOwnerId = dataTypeModelImpl._ownerId;

		dataTypeModelImpl._setOriginalOwnerId = false;
	...
	public CacheModel<DataType> toCacheModel() {
		...
		dataTypeCacheModel.isFavorite = getIsFavorite();

		dataTypeCacheModel.ownerId = getOwnerId();
	...
	private boolean _originalIsFavorite;
	private boolean _setOriginalIsFavorite;
