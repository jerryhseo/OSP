...
<portlet:actionURL var="addDataTypeEditorActionURL" name="addDataTypeEditorAction">
</portlet:actionURL> 

This is the <b>Add Editor</b> Main portlet in View mode.
...
%>
		<%-- <form action='<%= manageSimDataCollectionActionURL %>' method="post" enctype="multipart/form-data">
		 --%>
		 <form action='<%= addDataTypeEditorActionURL %>' method="post">
			...
			<br/> --%>
			<font>*  Enter data type editor ID:</font>
				<input type="text" name="<portlet:namespace />reqDataTypeEditorIdVal" value="33333" size=10 maxlength=10>
			<br/>
