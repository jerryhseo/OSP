...
<script type="text/javascript" src="/edison-simulation-portlet/js/jquery-1.10.2.min.js"></script>
<script type="text/javascript" src="/edison-simulation-portlet/js/jquery-ui.min.js"></script>
<!-- <script type="text/javascript" src="/edison-simulation-portlet/js/main.js"></script> -->
<!-- <link rel='stylesheet' href='/edison-simulation-portlet/css/jquery-ui.min.css'> -->
<!-- <link rel='stylesheet' href='/edison-simulation-portlet/css/main.css'> -->
			...
			<%
				...
				while (entries.hasNext()) {
					...
					if(key.equals("tabViewYn")){
						...
						out.print("	<td class='center'><select id=\"_"+PortalUtil.getPortletId(request)+"_valueTextBox\" class=\"btn btn-default\" name=\"_"+PortalUtil.getPortletId(request)+"_valueTextBox\" style=\"width:220px;\" onchange=\"changeTabViewYn(this,'"+value+"');\"><option value=\"Y\" "+selectedY+" >Y</option><option value=\"N\" "+selectedN+" >N</option></select>\n");
						out.print("</tr>\n");
					}
					j=j+1;
				}
				if(tabViewCount == 0){
					...
					out.print("	<td class='center'>tabViewYn<input type=\"hidden\" id=\"_"+PortalUtil.getPortletId(request)+"_keyTextBox\" name=\"_"+PortalUtil.getPortletId(request)+"_keyTextBox\" value=\"tabViewYn\" size=\"20\"></td>\n");
					out.print("	<td class='center'><select id=\"_"+PortalUtil.getPortletId(request)+"_valueTextBox\" class=\"btn btn-default\" name=\"_"+PortalUtil.getPortletId(request)+"_valueTextBox\" style=\"width:220px;\" onchange=\"changeTabViewYn(this,'');\"><option value=\"Y\">Y</option><option value=\"N\" selected=\"selected\" >N</option></select>\n");
					out.print("</tr>\n");
				}
			%>
			</tbody>
