                            ...
                            <div class="table-responsive panel edison-panel ">
                                <table class="table table-bordered table-hover edison-table" width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <thead>
                                        <tr>
                                            <th width="10%">
                                                <liferay-ui:message key="edison-table-list-header-index" />
                                            </th>
                                            <th>
                                                <liferay-ui:message key="edison-create-account-field-title-university" />
                                            </th>
                                            <th width="20%">
                                                <liferay-ui:message key="edison-science-appstore-view-regist-count" />
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody id="<portlet:namespace/>userTableBody">
                    ...
                    <script type="text/javascript">
                        ...
                        function setBar(barChartDateList) {
                            ...
                            if (barChartDateList != null) {
                                ...
                                chart2.xAxis[0].setCategories(xNameAxis);
                                chart2.addSeries({
                                    name: '<liferay-ui:message key="edison-science-appstore-view-regist-count" />',
                                    data: newData
                                });
