...
>>>>>>> theme-kdhan
                    ...
                    <div class="contabmenu">
                        <edison-ui:tabs names="<%=tabNames%>" tabsValues="<%=tabsValues%>" value="<%=selectedGroupId%>" refresh="<%=false%>" onClick="<%=portletNameSpace%>" minwidth="195" />
                    </div>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-bordered table-hover edison-table">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th align="center" scope="col">
                                            <liferay-ui:message key='edison-virtuallab-tablerow-virtuallab' />
                                        </th>
                                        <th align="center" scope="col">
                                            <liferay-ui:message key='edison-virtuallab-tablerow-virtualclass' />
                                        </th>
                                        <th align="center" scope="col">
                                            <liferay-ui:message key='edison-virtuallab-tablerow-professor' />
                                        </th>
                                        <th align="center" scope="col">
                                            <liferay-ui:message key='edison-class-statistics-sw-data' />
                                        </th>
                                        <!-- 활용SW -->
                                        <th align="center" scope="col">
                                            <liferay-ui:message key='edison-class-statistics-execute-student-count' />
                                        </th>
                                        <!-- 실행학생수 -->
                                        <th align="center" scope="col">
                                            <liferay-ui:message key='edison-class-statistics-class-code' />
                                        </th>
                                        <!-- 수업코드 -->
                                        <th align="center" scope="col">
                                        ...
                                        <!-- 실행수 -->
                                        <th align="center" scope="col">CPU Time</th>
                                        <!-- CPU Time -->
                                    </tr>
                                </thead>
                                <tbody id="classStatisticsListBody">
...
>>>>>>> theme-kdhan
                        ...
                        <script type="text/javascript">
                            ...
                            function < portlet: namespace / > tagScript(tabUrl, tabNames, value, scriptName) {
                                var searchData = {
                                    "<portlet:namespace/>groupId": value
                                };
