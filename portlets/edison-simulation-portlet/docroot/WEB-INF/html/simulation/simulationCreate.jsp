...
<div class="table3_list">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td width="180" class="title2"><liferay-ui:message key="edison-simulation-execute-simulation-name" /><span class="requiredField"> *</span></td>
				<td class="titleInput">
	...
	jQuery.ajax({
		...
		success: function(data) {
			...
			if(data.resultMsg == "SUCCESS"){
				...
				$("#<portlet:namespace/>metaMgtDate").text(data.scienceAppMap.statusDt);
