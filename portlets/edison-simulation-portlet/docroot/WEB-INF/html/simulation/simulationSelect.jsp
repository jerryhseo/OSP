	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="list" style="table-layout: fixed;">
		...
		<thead>
			<tr>
				...
				<th colspan="2"><liferay-ui:message key="edison-table-list-header-app-title" />(<liferay-ui:message key="edison-appstore-solver-name" />)</th>
...
//					insertAutoComplete();
				...
				for(var i=0; i<scienceAppList.length;i++){
					...
					$("<td/>").text(scienceAppList[i].screenName)
							 	.addClass("TC")
								.appendTo($vRow);
