...
/**
 * Provides the local service interface for VirtualLabClassStatistics. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author EDISON
 * @see VirtualLabClassStatisticsLocalServiceUtil
...
public interface VirtualLabClassStatisticsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VirtualLabClassStatisticsLocalServiceUtil} to access the virtual lab class statistics local service. Add custom service methods to {@link org.kisti.edison.bestsimulation.service.impl.VirtualLabClassStatisticsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
