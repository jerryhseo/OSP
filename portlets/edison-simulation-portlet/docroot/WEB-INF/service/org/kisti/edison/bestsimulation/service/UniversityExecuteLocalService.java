...
/**
 * Provides the local service interface for UniversityExecute. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author EDISON
 * @see UniversityExecuteLocalServiceUtil
...
public interface UniversityExecuteLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link UniversityExecuteLocalServiceUtil} to access the university execute local service. Add custom service methods to {@link org.kisti.edison.bestsimulation.service.impl.UniversityExecuteLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
