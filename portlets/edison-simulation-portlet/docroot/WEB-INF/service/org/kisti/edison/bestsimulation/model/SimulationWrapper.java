...
public class SimulationWrapper implements Simulation, ModelWrapper<Simulation> {
	...
	*/
	...
	/**
	* Returns the class ID of this simulation.
	*
	* @return the class ID of this simulation
	*/
	@Override
	public long getClassId() {
		return _simulation.getClassId();
	}

	/**
	* Sets the class ID of this simulation.
	*
	* @param classId the class ID of this simulation
	*/
	@Override
	public void setClassId(long classId) {
		_simulation.setClassId(classId);
	}

	/**
	* Returns the custom ID of this simulation.
	*
	* @return the custom ID of this simulation
	*/
	@Override
	public long getCustomId() {
		return _simulation.getCustomId();
	}

	/**
	* Sets the custom ID of this simulation.
	*
	* @param customId the custom ID of this simulation
	*/
	@Override
	public void setCustomId(long customId) {
		_simulation.setCustomId(customId);
	}
	...
	*/
	...
	/**
	* Returns <code>true</code> if this simulation is test yn.
	*
	* @return <code>true</code> if this simulation is test yn; <code>false</code> otherwise
	*/
	@Override
	public boolean isTestYn() {
		return _simulation.isTestYn();
	}

	/**
	* Sets whether this simulation is test yn.
	*
