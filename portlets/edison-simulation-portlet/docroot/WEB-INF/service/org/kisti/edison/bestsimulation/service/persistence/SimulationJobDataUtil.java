...
/**
 * The persistence utility for the simulation job data service. This utility wraps {@link SimulationJobDataPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see SimulationJobDataPersistenceImpl
 * @generated
 */
public class SimulationJobDataUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(SimulationJobData simulationJobData) {
		getPersistence().clearCache(simulationJobData);
	}
	 ...
	 */
	public static List<SimulationJobData> findWithDynamicQuery(
	 ...
	 */
	public static SimulationJobData update(SimulationJobData simulationJobData)
		throws SystemException {
		return getPersistence().update(simulationJobData);
	}

	/**
	 * @see com.liferay.portal.service.persistence.BasePersistence#update(com.liferay.portal.model.BaseModel, ServiceContext)
	 */
	public static SimulationJobData update(
		SimulationJobData simulationJobData, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(simulationJobData, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(simulationJobData);
	}
	...
	*/
	public static void cacheResult(
		java.util.List<org.kisti.edison.bestsimulation.model.SimulationJobData> simulationJobDatas) {
		getPersistence().cacheResult(simulationJobDatas);
	}
	...
	*/
	public static org.kisti.edison.bestsimulation.model.SimulationJobData create(
		java.lang.String jobUuid) {
		return getPersistence().create(jobUuid);
	}
	...
	*/
	public static org.kisti.edison.bestsimulation.model.SimulationJobData remove(
		java.lang.String jobUuid)
		throws com.liferay.portal.kernel.exception.SystemException,
			org.kisti.edison.bestsimulation.NoSuchSimulationJobDataException {
		return getPersistence().remove(jobUuid);
	}

	public static org.kisti.edison.bestsimulation.model.SimulationJobData updateImpl(
		org.kisti.edison.bestsimulation.model.SimulationJobData simulationJobData)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(simulationJobData);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static org.kisti.edison.bestsimulation.model.SimulationJobData findByPrimaryKey(
		java.lang.String jobUuid)
		throws com.liferay.portal.kernel.exception.SystemException,
			org.kisti.edison.bestsimulation.NoSuchSimulationJobDataException {
		return getPersistence().findByPrimaryKey(jobUuid);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static org.kisti.edison.bestsimulation.model.SimulationJobData fetchByPrimaryKey(
		java.lang.String jobUuid)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(jobUuid);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<org.kisti.edison.bestsimulation.model.SimulationJobData> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static SimulationJobDataPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (SimulationJobDataPersistence)PortletBeanLocatorUtil.locate(org.kisti.edison.bestsimulation.service.ClpSerializer.getServletContextName(),
					SimulationJobDataPersistence.class.getName());

			ReferenceRegistry.registerReference(SimulationJobDataUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(SimulationJobDataPersistence persistence) {
	}

	private static SimulationJobDataPersistence _persistence;
}