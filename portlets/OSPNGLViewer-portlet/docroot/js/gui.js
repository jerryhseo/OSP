...
NGL.StageWidget = function (stage, id) {
  ...
  parentDomElement.appendChild(cssLinkElement)

  //

  var toolbar = new NGL.ToolbarWidget(stage).setId('toolbar')
  parentDomElement.appendChild(toolbar.dom)

  var menubar = new NGL.MenubarWidget(stage, preferences).setId('menubar')
  parentDomElement.appendChild(menubar.dom)

  var sidebar = new NGL.SidebarWidget(stage).setId('sidebar')
  parentDomElement.appendChild(sidebar.dom)

  //

  parentDomElement.style.touchAction = 'none';
...
NGL.MenubarViewWidget = function (stage, preferences) {
  ...
  function onFullScreenOptionClick () {
    stage.toggleFullscreen(document.getElementsByTagName("portlet-borderless.ospngl-portlet").dom)
  }
...
NGL.MenubarExamplesWidget = function (stage) {
  ...
  var exampleList = JSON.parse('["color/atomindex","color/bfactor","color/chainid","color/custom","color/electrostatic","color/element","color/modelindex","color/partialcharge","color/resname","color/selection","color/sstruc","color/volume-esp","color/volume","component/getByName","component/matrix","component/shape-buffer","component/shape-cat","component/shape-wireframe","component/shape","component/structure-autoChainName","component/structure-biomol","component/structure-biomolSimple","component/structure-bondOrders","component/structure-coarseGrained","component/structure-cyclic","component/structure-dna","component/structure-multiModel","component/structure-superpose","component/transform","interactive/annotation","interactive/hover-tooltip","interactive/interpolate","interactive/simple-viewer","interactive/xray-viewer","parser/brix","parser/ccp4","parser/cif-chemComp","parser/cif-core","parser/cif","parser/cns","parser/cube-benzene","parser/cube-big","parser/cube-bromobenzene","parser/cube-protein","parser/cube","parser/dcd-large","parser/dcd","parser/dsn6","parser/dx","parser/dxbin","parser/gro-large","parser/gro-trajectory","parser/gro","parser/map","parser/mmtf-reduced","parser/mmtf","parser/mol2","parser/mrc","parser/nctraj","parser/obj","parser/pdb","parser/ply","parser/pqr","parser/prmtop","parser/psf","parser/sdf-models","parser/sdf","parser/top","parser/trr","parser/validation","parser/xtc","representation/angle","representation/axes","representation/contact","representation/dihedral","representation/distance","representation/helixorient","representation/hyperball","representation/label","representation/line-and-cross","representation/line","representation/molecularsurface-av","representation/molecularsurface-filter","representation/molecularsurface","representation/point","representation/representation-lazy","representation/rocket","representation/slice","representation/tube-bfactor","representation/unitcell","selection/basic","selection/bonded","selection/component","selection/large","selection/ring","selection/spatialHash","selection/sstruc","showcase/chlorellaVirus","showcase/electrostatic-apbs","showcase/ferredoxin","showcase/ferritin","showcase/gfp","showcase/hiv","showcase/norovirus","showcase/qmean","showcase/rhodopsin","showcase/ribosome","showcase/viruses","test/1blu","test/2buk","test/alignment","test/alignment2","test/backboneTypeChange","test/explode","test/helixorient_issue-7","test/impostor","test/inter-bonds","test/map-shift","test/molsurf-object","test/orient","test/pbc","test/pdbDaminoacids","test/pdbModifiedResidue","test/pickingImage","test/superposition","test/timing","test/xray"]');
  exampleList.sort().forEach(function (name) {
  	console.log("KYJ insert string ::"+NGL.examplesScriptUrl + name + '.js');
