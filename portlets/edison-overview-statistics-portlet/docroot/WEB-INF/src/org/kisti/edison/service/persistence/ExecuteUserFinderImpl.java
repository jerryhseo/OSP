 ...
 * @generated
 */
public class ExecuteUserFinderImpl extends BasePersistenceImpl<ExecuteUser> implements ExecuteUserFinder{
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public int getExecuteUserTotalCount() throws SystemException{
		StringBuilder sqlSb = new StringBuilder();
		Session session = null;
		int cnt = 0;
		
		try{
			String sqlSelect = CustomSQLUtil.get("org.kisti.edison.overviewStatistics.getExecuteUserTotalCount");
	...
	public List<Object[]> getExecuteUserCountByDate() throws SystemException{
		StringBuilder sqlSb = new StringBuilder();
		Session session = null;
		int cnt = 0;
		
		try{
			String sqlSelect = CustomSQLUtil.get("org.kisti.edison.overviewStatistics.getExecuteUserCountByDate");
	...
	public int updateExecuteUserStatistics() throws SystemException{
		StringBuilder sqlSb = new StringBuilder();
		Session session = null;
		
		try{
			String sqlSelect = CustomSQLUtil.get("org.kisti.edison.overview.schedule.updateExecuteUser");
