 ...
 * @generated
 */
public class CitationsFinderImpl extends BasePersistenceImpl<Citations> implements CitationsFinder{
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public int getCitationsTotalCount() throws SystemException{
		StringBuilder sqlSb = new StringBuilder();
		Session session = null;
		int cnt = 0;
		
		try{
			String sqlSelect = CustomSQLUtil.get("org.kisti.edison.overviewStatistics.getCitationsTotalCount");
	...
	public List<Object[]> getCitationsCountByDate() throws SystemException{
		StringBuilder sqlSb = new StringBuilder();
		Session session = null;
		int cnt = 0;
		
		try{
			String sqlSelect = CustomSQLUtil.get("org.kisti.edison.overviewStatistics.getCitationsCountByDate");
	...
	public List<Object[]> getCitationsCountBySite() throws SystemException{
		StringBuilder sqlSb = new StringBuilder();
		Session session = null;
		int cnt = 0;
		...
		try{
			...
			String sqlSelect = CustomSQLUtil.get("org.kisti.edison.overviewStatistics.getCitationsCountBySite");
	...
	public int updateCitationsStatistics() throws SystemException{
		StringBuilder sqlSb = new StringBuilder();
		Session session = null;
		
		try{
			String sqlSelect = CustomSQLUtil.get("org.kisti.edison.overview.schedule.updateCitations");
