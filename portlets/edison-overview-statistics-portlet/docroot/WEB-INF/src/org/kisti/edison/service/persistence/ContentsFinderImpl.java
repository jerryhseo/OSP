 ...
 * @generated
 */
public class ContentsFinderImpl extends BasePersistenceImpl<Contents> implements ContentsFinder{
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public int getContentsTotalCount() throws SystemException{
		StringBuilder sqlSb = new StringBuilder();
		Session session = null;
		int cnt = 0;
		
		try{
			String sqlSelect = CustomSQLUtil.get("org.kisti.edison.overviewStatistics.getContentsTotalCount");
	...
	public List<Object[]> getContentsCountByDate() throws SystemException{
		StringBuilder sqlSb = new StringBuilder();
		Session session = null;
		int cnt = 0;
		
		try{
			String sqlSelect = CustomSQLUtil.get("org.kisti.edison.overviewStatistics.getContentsCountByDate");
	...
	public List<Object[]> getContentsCountBySite() throws SystemException{
		StringBuilder sqlSb = new StringBuilder();
		Session session = null;
		int cnt = 0;
		...
		try{
			...
			String sqlSelect = CustomSQLUtil.get("org.kisti.edison.overviewStatistics.getContentsCountBySite");
	...
	public int updateContentsStatistics() throws SystemException{
		StringBuilder sqlSb = new StringBuilder();
		Session session = null;
		
		try{
			String sqlSelect = CustomSQLUtil.get("org.kisti.edison.overview.schedule.updateContents");
