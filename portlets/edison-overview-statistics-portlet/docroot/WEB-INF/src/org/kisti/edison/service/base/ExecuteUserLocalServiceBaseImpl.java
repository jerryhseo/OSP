...
import org.kisti.edison.service.ExecuteUserLocalService;
...
/**
 * Provides the base implementation for the execute user local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.kisti.edison.service.impl.ExecuteUserLocalServiceImpl}.
 * </p>
 *
 * @author edison
 ...
 * @generated
 */
public abstract class ExecuteUserLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ExecuteUserLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.kisti.edison.service.ExecuteUserLocalServiceUtil} to access the execute user local service.
	 */
	...
	@Override
	public ExecuteUser addExecuteUser(ExecuteUser executeUser)
		throws SystemException {
		executeUser.setNew(true);

		return executeUserPersistence.update(executeUser);
	}
	 ...
	 */
	@Override
	public ExecuteUser createExecuteUser(String createDate) {
		return executeUserPersistence.create(createDate);
	}
	...
	@Override
	public ExecuteUser deleteExecuteUser(String createDate)
		throws PortalException, SystemException {
		return executeUserPersistence.remove(createDate);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ExecuteUser deleteExecuteUser(ExecuteUser executeUser)
		throws SystemException {
		return executeUserPersistence.remove(executeUser);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ExecuteUser.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return executeUserPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return executeUserPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return executeUserPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ExecuteUser fetchExecuteUser(String createDate)
		throws SystemException {
		return executeUserPersistence.fetchByPrimaryKey(createDate);
	}
	 ...
	 */
	@Override
	public ExecuteUser getExecuteUser(String createDate)
		throws PortalException, SystemException {
		return executeUserPersistence.findByPrimaryKey(createDate);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return executeUserPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ExecuteUser> getExecuteUsers(int start, int end)
		throws SystemException {
		return executeUserPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getExecuteUsersCount() throws SystemException {
		return executeUserPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ExecuteUser updateExecuteUser(ExecuteUser executeUser)
		throws SystemException {
		return executeUserPersistence.update(executeUser);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("org.kisti.edison.model.ExecuteUser",
			executeUserLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = executeUserPersistence.getDataSource();
	...
	private ExecuteUserLocalServiceClpInvoker _clpInvoker = new ExecuteUserLocalServiceClpInvoker();
}