...
/**
 * Provides the local service interface for Contents. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author edison
 * @see ContentsLocalServiceUtil
...
public interface ContentsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ContentsLocalServiceUtil} to access the contents local service. Add custom service methods to {@link org.kisti.edison.service.impl.ContentsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
