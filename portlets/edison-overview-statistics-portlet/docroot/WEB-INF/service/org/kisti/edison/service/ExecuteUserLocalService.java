...
/**
 * Provides the local service interface for ExecuteUser. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author edison
 * @see ExecuteUserLocalServiceUtil
...
public interface ExecuteUserLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ExecuteUserLocalServiceUtil} to access the execute user local service. Add custom service methods to {@link org.kisti.edison.service.impl.ExecuteUserLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
