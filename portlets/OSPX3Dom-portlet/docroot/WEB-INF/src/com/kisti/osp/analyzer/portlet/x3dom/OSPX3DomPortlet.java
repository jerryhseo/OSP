package com.kisti.osp.analyzer.portlet.x3dom;
...
/**
 * Portlet implementation class OSPX3DomPortlet
 */
public class OSPX3DomPortlet extends MVCPortlet {
    private static Log _log = LogFactoryUtil.getLog(OSPX3DomPortlet.class);
