...
import org.kisti.eturb.dbservice.model.impl.ProjectImpl;
import org.kisti.eturb.dbservice.model.impl.ProjectModelImpl;
...
public class ProjectPersistenceImpl extends BasePersistenceImpl<Project>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_USERID = new FinderPath(ProjectModelImpl.ENTITY_CACHE_ENABLED,
			ProjectModelImpl.FINDER_CACHE_ENABLED, ProjectImpl.class,
	...
	@Override
	public Project updateImpl(org.kisti.eturb.dbservice.model.Project project)
		throws SystemException {
		project = toUnwrappedModel(project);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.org.kisti.eturb.dbservice.model.Project")));
