...
import org.kisti.eturb.util.MonitoringStatusConstatns;
...
public class TreeViewMonitoringController{
    ...
    private static final String ICEBREAKER_TEMP_PATH = PropsUtil.get(PropsKeys.LIFERAY_HOME) + "/ICEBREAKER_TEMP";
    ...
    public void getResultFiles(ResourceRequest request, ResourceResponse response, ModelMap model)
        ...
        try{
            ...
            IcebreakerVcToken vcToken = IBUserTokenUtil.getOrCreateToken(groupId, user);
