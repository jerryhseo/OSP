...
import org.kisti.eturb.dbservice.model.ProjectClp;
import org.kisti.eturb.dbservice.model.SimulationClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"eturb-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "eturb-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"org.kisti.eturb.dbservice.model.impl.ProjectImpl")) {
		...
		if (oldModelClassName.equals(
					"org.kisti.eturb.dbservice.model.impl.SimulationImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("org.kisti.eturb.dbservice.NoSuchProjectException")) {
			return new org.kisti.eturb.dbservice.NoSuchProjectException();
		}

		if (className.equals(
					"org.kisti.eturb.dbservice.NoSuchSimulationException")) {
			return new org.kisti.eturb.dbservice.NoSuchSimulationException();
		}
