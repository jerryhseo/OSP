...
<link type="text/css" rel="stylesheet"	href="${contextPath}/css/jquery.imageview.css" media="screen" />
...
<div class="row" style="margin-bottom: 10px;">
	<div class="col-md-12 topvisual">
		...
		<div class="topvisualbtnbox" align="right" style="padding-right: 10px;">
			...
			<c:if test="${isOwner eq false && isMember eq false && data.projectOpenYn eq true && isMemberRequest eq false && isTempUser eq false}">
...
<div class="row">
	<div class="col-md-9" style="padding: 0px;">
		<c:if test="${data.projectOpenYn eq true && fn:length(data.projectImageList) > 0}">
