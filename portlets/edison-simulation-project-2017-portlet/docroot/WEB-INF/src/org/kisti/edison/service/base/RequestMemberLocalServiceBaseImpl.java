...
import org.kisti.edison.service.RequestMemberLocalService;
...
/**
 * Provides the base implementation for the request member local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.kisti.edison.service.impl.RequestMemberLocalServiceImpl}.
 * </p>
 *
 * @author edison
 ...
 * @generated
 */
public abstract class RequestMemberLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements RequestMemberLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.kisti.edison.service.RequestMemberLocalServiceUtil} to access the request member local service.
	 */
	...
	@Override
	public RequestMember addRequestMember(RequestMember requestMember)
		throws SystemException {
		requestMember.setNew(true);

		return requestMemberPersistence.update(requestMember);
	}
	 ...
	 */
	@Override
	public RequestMember createRequestMember(RequestMemberPK requestMemberPK) {
		return requestMemberPersistence.create(requestMemberPK);
	}
	...
	@Override
	public RequestMember deleteRequestMember(RequestMemberPK requestMemberPK)
		throws PortalException, SystemException {
		return requestMemberPersistence.remove(requestMemberPK);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public RequestMember deleteRequestMember(RequestMember requestMember)
		throws SystemException {
		return requestMemberPersistence.remove(requestMember);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(RequestMember.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return requestMemberPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return requestMemberPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public RequestMember fetchRequestMember(RequestMemberPK requestMemberPK)
		throws SystemException {
		return requestMemberPersistence.fetchByPrimaryKey(requestMemberPK);
	}
	 ...
	 */
	@Override
	public RequestMember getRequestMember(RequestMemberPK requestMemberPK)
		throws PortalException, SystemException {
		return requestMemberPersistence.findByPrimaryKey(requestMemberPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return requestMemberPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<RequestMember> getRequestMembers(int start, int end)
		throws SystemException {
		return requestMemberPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getRequestMembersCount() throws SystemException {
		return requestMemberPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public RequestMember updateRequestMember(RequestMember requestMember)
		throws SystemException {
		return requestMemberPersistence.update(requestMember);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("org.kisti.edison.model.RequestMember",
			requestMemberLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = requestMemberPersistence.getDataSource();
	...
	private RequestMemberLocalServiceClpInvoker _clpInvoker = new RequestMemberLocalServiceClpInvoker();
}