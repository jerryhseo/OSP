...
<div class="row" style="height: 50%;" id="row-${namespace}${layoutKey}column-3">
	<div class="col-md-12 col sub-col" style="height: 100%;width: 50%;" id="${namespace}${layoutKey}column-3">
...
<div class="devider horizontal" id="${namespace}${layoutKey}devider-2" data-equal-id="row-${namespace}${layoutKey}column-3" data-remainder-id="row-${namespace}${layoutKey}column-5"></div>
<div class="row" style="height: 50%;" id="row-${namespace}${layoutKey}column-5">
	...
	<div class="devider vertical" id="${namespace}${layoutKey}devider-3" data-equal-id="${namespace}${layoutKey}column-5" data-remainder-id="${namespace}${layoutKey}column-6"></div>
	<div class="col-md-12 col sub-col" style="height: 100%;width: 50%;"id="${namespace}${layoutKey}column-6">
