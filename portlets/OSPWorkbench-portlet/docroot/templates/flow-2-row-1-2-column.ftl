			...
			<section class="content" id="workbench-layout-area" style="display:none;height:94%;">
				...
				<div class="flow-grid" style="display:none;height: 100%;" id="OUTPUT">
					...
					<div class="row" style="height: 50%;"id="${namespace}row-column-7">
						<div class="col-md-12 col sub-col" style="height: 100%;width:50%;" id="${namespace}column-7">
							
						</div>
						<div class="devider vertical" id="${namespace}devider-2" data-equal-id="${namespace}column-7" data-remainder-id="${namespace}column-8"></div>
						<div class="col-md-12 col sub-col" style="height: 100%;width:50%;" id="${namespace}column-8">
