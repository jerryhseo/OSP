...
<div class="col-md-12"  style="height:100%;width:50%;" id="col-${namespace}${layoutKey}column-3">
	<div class="row" style="height:50%" id="row-${namespace}${layoutKey}column-3">
		<div class="col-md-12 col sub-col" style="height:100%" id="${namespace}${layoutKey}column-3" set-width="false" set-width-id="col-${namespace}${layoutKey}column-3">
	...
	<div class="row" style="height:50%" id="row-${namespace}${layoutKey}column-4">
		<div class="col-md-12 col sub-col"style="height:100%" id="${namespace}${layoutKey}column-4" set-width="false">
		
		</div>
	</div>
</div>
<div class="devider vertical" id="${namespace}${layoutKey}devider-2" data-equal-id="col-${namespace}${layoutKey}column-3" data-remainder-id="${namespace}${layoutKey}column-5"></div>
<div class="col-md-12 col"  style="height:100%;width:50%;" id="${namespace}${layoutKey}column-5">
