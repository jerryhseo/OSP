		...
		<div class="content-wrapper">
			...
			<section class="content" id="workbench-layout-area" style="display:none;height:94%;">
				...
				<div class="row" style="height: 50%;"id="${namespace}row-column-5">
					...
					<div class="devider vertical" id="${namespace}devider-2" data-equal-id="${namespace}column-5" data-remainder-id="${namespace}column-6"></div>
					<div class="col-md-12 col sub-col" style="height: 100%;width:50%;" id="${namespace}column-6">
