...
public class AppStatisticsController {
	...
	public void getStatisticsExec(ResourceRequest request, ResourceResponse response) throws PortalException, SystemException, ParseException, JSONException, IOException{
		...
		try{
			...
			obj.put("dataList", SimulationJobLocalServiceUtil.getAppDetailListForProjectStatistics(1301003, column.getColumnId(),selectProjectCategory,  themeDisplay.getLanguageId(), themeDisplay.getLocale()));
	...
	public void excelDown(ResourceRequest request, ResourceResponse response){
		...
		try {		
			...
			List appDetailList  = SimulationJobLocalServiceUtil.getAppDetailListForProjectStatistics(1301003, column.getColumnId(), selectProjectCategory, themeDisplay.getLanguageId(), themeDisplay.getLocale());
