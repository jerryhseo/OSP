...
public class ContentStatisticsController {
	...
	public void getStatisticsExec(ResourceRequest request, ResourceResponse response) throws PortalException, SystemException, ParseException, JSONException, IOException{
		...
		try{
			...
			obj.put("dataList", ContentLocalServiceUtil.getContentDatailListForProjectStatistics("Y", column.getColumnId(), selectProjectCategory, themeDisplay.getLanguageId(), themeDisplay.getLocale()));
	...
	public void excelDown(ResourceRequest request, ResourceResponse response){
		...
		try {		
			...
			List contentDetailList  = ContentLocalServiceUtil.getContentDatailListForProjectStatistics("Y", column.getColumnId(), selectProjectCategory, themeDisplay.getLanguageId(), themeDisplay.getLocale());
