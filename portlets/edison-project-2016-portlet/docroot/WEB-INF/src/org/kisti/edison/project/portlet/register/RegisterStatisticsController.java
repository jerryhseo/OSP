...
public class RegisterStatisticsController {
	...
	public void getStatisticsExec(ResourceRequest request, ResourceResponse response) throws PortalException, SystemException, ParseException, JSONException, IOException{
		...
		try {
			...
			obj.put("scienceAppCenterList", SimulationJobLocalServiceUtil.getScienceAppCenterListForProjectStatistics("SITE", themeDisplay.getLocale()));
			obj.put("contentCenterList", ContentLocalServiceUtil.getContentCenterListForProjectStatistics("Y","SITE", themeDisplay.getLocale()));
