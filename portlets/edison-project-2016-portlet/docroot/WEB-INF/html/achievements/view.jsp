...
// 								.append($("<td/>").attr("width", "25%").append("&nbsp;"))
								...
								.append($("<td/>").addClass("TC").append(
										$("<a/>").attr("href","javascript:void(0);").attr("onclick", "<portlet:namespace/>moveAppDetail('"+dataMap[i].appDetailPlid+"','"+dataMap[i].projectCategoryId+"')").css("color","#fff").append(dataMap[i].appCnt)))
								
								)//thead end
							.append($("<tr/>")
								.append($("<td/>").attr("width", "41%").addClass("TR").append("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Content"))
								.append($("<td/>").addClass("TC").append(
										$("<a/>").attr("href","javascript:void(0);").attr("onclick", "<portlet:namespace/>moveContentDetail('"+dataMap[i].contentDetailPlid+"','"+dataMap[i].projectCategoryId+"')").css("color","#fff").append(dataMap[i].conCnt))))
							);
