    ...
    function f(b, c) {
        ...
        return d += '<div class="md-loading"><span class="md-icon-container"><span class="md-icon"></span></span></div>', 
        	   ...
        	   d += '<button type="button" data-mdtooltip="tooltip" title="' + c.label.btnHeader1 + '" class="md-btn btn btn-sm btn-default" data-btn="h1">H1</button>', 
	   		   ...
	   		   d += "</div>", d += '<div class="btn-group">', 
	   		   d += '<button type="button" data-mdtooltip="tooltip" title="' + c.label.btnBold + '" class="md-btn btn btn-sm btn-default" data-btn="bold"><i class="icon-bold"></i></button>', 
	   		   d += '<button type="button" data-mdtooltip="tooltip" title="' + c.label.btnItalic + '" class="md-btn btn btn-sm btn-default" data-btn="italic"><i class="icon-italic"></i></button>', 
	   		   d += "</div>", 
	   		   d += '<div class="btn-group">', 
	   		   d += '<button type="button" data-mdtooltip="tooltip" title="' + c.label.btnList + '" class="md-btn btn btn-sm btn-default" data-btn="ul"><i class="icon-list"></i></button>', 
	   		   d += '<button type="button" data-mdtooltip="tooltip" title="' + c.label.btnOrderedList + '" class="md-btn btn btn-sm btn-default" data-btn="ol"><i class="icon-list-ol"></i></button>', 
	   		   d += "</div>", 
	   		   d += '<div class="btn-group">', 
	   		   d += '<button type="button" data-mdtooltip="tooltip" title="' + c.label.btnLink + '" class="md-btn btn btn-sm btn-default" data-btn="link"><i class="icon-link"></i></button>', 
	   		   d += '<button type="button" data-mdtooltip="tooltip" title="' + c.label.btnImage + '" class="md-btn btn btn-sm btn-default" data-btn="image"><i class="icon-picture"></i></button>', 
	   		   c.imageUpload === !0 && (d += '<div data-mdtooltip="tooltip" title="' + c.label.btnUpload + '" class="btn btn-sm btn-default md-btn-file"><i class="icon-upload"></i><input class="md-input-upload" type="file" multiple accept=".jpg,.jpeg,.png,.gif"></div>'), 
	   		   d += "</div>", 
	   		   /*c.fullscreen === !0 && (d += '<div class="btn-group pull-right">', 
	   		   d += '<button type="button" class="md-btn btn btn-sm btn-default" data-btn="fullscreen"><i class="icon-fullscreen"></i> ' + c.label.btnFullscreen + "</button>", 
	   		   d += "</div>"), */
	   		   c.preview === !0 && (d += '<div class="btn-group pull-right">', 
	   		   d += '<button type="button" class="md-btn btn btn-sm btn-default btn-edit active" data-btn="edit"><i class="icon-pencil"></i></span> ' + c.label.btnEdit + "</button>", 
	   		   d += '<button type="button" class="md-btn btn btn-sm btn-default btn-preview" data-btn="preview"><i class="icon-eye-open"></i></span> ' + c.label.btnPreview + "</button>", 
	   		   d += "</div>"), 
	   		   d += "</div>", 
	   		   d += "</div>", 
