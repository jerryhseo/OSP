...
(function(factory) {
  ...
  Markdown.prototype = {
      ...
      if (this.$editor === null) {
        ...
        if (options.additionalButtons.length > 0) {
          ...
          $.each(options.additionalButtons[0], function(idx, buttonGroup) {
            ...
            // see if the group name of the additional group matches an existing
			// group
            var matchingGroups = $.grep(allBtnGroups, function(allButtonGroup, allIdx) {
              return allButtonGroup.name === buttonGroup.name;
            });

            // if it matches add the additional buttons to that group, if not
			// just add it to the all buttons group
    ...
    showPreview: function() {
      ...
      // Set the content based on the callback content if string, otherwise
    ...
    keyup: function(e) {
      ...
      switch (e.keyCode) {
        ...
        case 13: // enter
          ...
          // traverse backwards through chars to check if last line break was
			// num/bullet item
    ...
    addBullet: function(index) {
      ...
      this.setSelection(index + 2, index + 2); // Put the cursor after the
												// bullet
    },
    addNumberedBullet: function(index, num) {
      ...
      this.setSelection(index + prefixLength, index + prefixLength); // Put
																		// the
																		// cursor
																		// after
																		// the
