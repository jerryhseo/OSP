...
<div class="content">
	...
	<div class="left edison-panel" id="inputDeckParameterLeft">
		<table id="<portlet:namespace/>variableTable" class = "table table-bordered table-hover edison-table">
			<thead>
				<tr>
	...
	<div class="right">
		...
		<div id="btnGroupBottom" class="updateBtnGroup">
			...
			<button class="btn btn-default actieveBtn" id="variableActivationBtn" type="button" onclick="<portlet:namespace/>changeType('','add');"><span class="icon-remove">   <liferay-ui:message key='cancel' /></span></button>
			<button class="btn btn-default actieveBtn" id="variableActivationBtn" type="button" onclick="<portlet:namespace/>paraSave(true,true);"><span class="icon-edit">   <liferay-ui:message key='add' /></span></button>
