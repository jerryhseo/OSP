...
<div class="panel-body sortableLayout gridLayoutArea">
	...
	<div class="devider horizontal" data-equal-id="row-column-4" data-remainder-id="row-column-5" set-equal-ids="column-4" set-remainder-ids="column-5|column-6"></div>
	<div class="row" style="height: 50%;"id="row-column-5">
		...
		<div class="devider vertical" data-equal-id="col-column-5" data-remainder-id="col-column-6" set-equal-ids="column-5" set-remainder-ids="column-6"></div>
