...
<div class="panel-body sortableLayout gridLayoutArea">
	...
	<div class="devider horizontal" id="devider-1" data-equal-id="row-column-3" data-remainder-id="row-column-4" set-equal-ids="column-3" set-remainder-ids="column-4|column-5"></div>
	<div class="row" style="height: 50%;"id="row-column-4">
		...
		<div class="devider vertical" id="devider-2" data-equal-id="col-column-4" data-remainder-id="col-column-5" set-equal-ids="column-4" set-remainder-ids="column-5"></div>
