...
<div class="panel-body sortableLayout gridLayoutArea">
	...
	<div class="devider horizontal" id="devider-2" data-equal-id="row-column-3" data-remainder-id="row-column-5" set-equal-ids="column-3|column-4" set-remainder-ids="column-5"></div>
