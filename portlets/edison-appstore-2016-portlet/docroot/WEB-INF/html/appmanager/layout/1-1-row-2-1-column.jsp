...
<div class="panel-body sortableLayout gridLayoutArea">
	<div class="row" style="height:100%">
		...
		<div class="devider vertical" id="devider-2" data-equal-id="col-column-4" data-remainder-id="col-column-6" set-equal-ids="column-4|column-5" set-remainder-ids="column-6"></div>
