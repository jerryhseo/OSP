...
<div class="panel-body sortableLayout gridLayoutArea">
	<div class="row" style="height:100%">
		<div class="col-md-12"  style="height:100%;width:50%;" id="col-column-3">
		...
		<div class="devider vertical" id="devider-2" data-equal-id="col-column-3" data-remainder-id="col-column-5" set-equal-ids="column-3|column-4" set-remainder-ids="column-5"></div>
		<div class="col-md-12 col"  style="height:100%;width:50%;" id="col-column-5">
			<ul class="sortable-list ui-sortable list-group" id="column-5" data-init-area="output" style="height:100%">
			</ul>
		</div>
	</div>
</div>