...
<div class="panel-body sortableLayout gridLayoutArea">
	<div class="row" style="height:100%">
		<div class="col-md-12 col" style="height:100%;width:50%;" id="col-column-3">
			<ul class="sortable-list ui-sortable list-group" id="column-3" data-init-area="output">
			</ul>
		</div>
		<div class="devider vertical" id="devider-1" data-equal-id="col-column-3" data-remainder-id="col-column-4" set-equal-ids="column-3" set-remainder-ids="column-4|column-5"></div>
		<div class="col-md-12" style="height:100%;width:50%;" id="col-column-4">
			...
			<div class="devider horizontal" id="devider-2" data-equal-id="row-column-4" data-remainder-id="row-column-5" set-equal-ids="column-4" set-remainder-ids="column-5"></div>
