...
<div class="panel-body sortableLayout gridLayoutArea">
	<div class="row" style="height: 50%;" id="row-column-3">
		<div class="col-md-12 col sub-col" style="height: 100%;width: 50%;" id="col-column-3">
	...
	<div class="devider horizontal" id="devider-2" data-equal-id="row-column-3" data-remainder-id="row-column-5" set-equal-ids="column-3|column-4" set-remainder-ids="column-5|column-6"></div>
	<div class="row" style="height: 50%;" id="row-column-5">
		...
		<div class="devider vertical" id="devider-3" data-equal-id="col-column-5" data-remainder-id="col-column-6" set-equal-ids="column-5" set-remainder-ids="column-6"></div>
