...
<div class="panel-body sortableLayout gridLayoutArea">
	<div class="row" style="height:100%">
		...
		<div class="devider vertical" id="devider-2" data-equal-id="col-column-4" data-remainder-id="col-column-6" set-equal-ids="column-4|column-5" set-remainder-ids="column-6|column-7"></div>
		<div class="col-md-12 col" style="height: 100%;width: 50%;" id="col-column-6">
			...
			<div class="devider horizontal" id="devider-3" data-equal-id="row-column-6" data-remainder-id="row-column-7" set-equal-ids="column-6" set-remainder-ids="column-7"></div>
