	...
	<div class="newWcont01">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="data" >
			...
			<tr class="puptrline">
				...
				<td class="puptxt">
					<textarea rows="" cols="" id="lib_file_content" class="text_field" maxlength="500" ${disabled}>${data.requiredContent}</textarea>
				</td>
			</tr>
			<c:if test="${!empty data.confirmContent}">
				<tr class="puptrline">
					...
					<td class="puptxt">
						<textarea rows="" cols="" id="lib_file_content" class="text_field" maxlength="500" disabled="disabled">${data.confirmContent}</textarea>
					</td>
				</tr>
			</c:if>
...
function <portlet:namespace/>saveRequestLib() {
	if(confirm(Liferay.Language.get('would-you-like-to-save'))){
		...
		var content = $("#lib_file_content").val();
