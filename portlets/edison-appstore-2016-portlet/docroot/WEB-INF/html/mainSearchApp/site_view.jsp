				...
				<div class="mainvisual">
						<div style="position: relative;">
							<div class="main-simul">
								<div id="l_Simulation" class="simtitle" style="cursor:pointer;" onclick="<portlet:namespace/>appStoreGo()">AppStore</div>
										<div id="l_Simulation01" class="simbtn">
											...
											<map name="Map" id="Map">
											<area shape="circle" coords="104,104,104" href="javascript:;" onfocus="blur();" onclick="<portlet:namespace/>appStoreGo()" />
											</map>
										</div>
										<div id="l_Simulation02" class="siminfo" onclick="<portlet:namespace/>appStoreGo()" style="cursor:pointer;">GO</div>
								</div>
								<div id="l-app" class="main_app">
									<div id="l-apptitle" class="apptitle">ScienceApp</div>
