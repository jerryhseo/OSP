...
/**
 * Provides the local service interface for ScienceAppOutputPorts. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author EDISON
 * @see ScienceAppOutputPortsLocalServiceUtil
...
public interface ScienceAppOutputPortsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ScienceAppOutputPortsLocalServiceUtil} to access the science app output ports local service. Add custom service methods to {@link org.kisti.edison.science.service.impl.ScienceAppOutputPortsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
