...
public class ScienceAppClp extends BaseModelImpl<ScienceApp>
	...
	public void setLayout(String layout) {
		...
		if (_scienceAppRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setLayout", String.class);

				method.invoke(_scienceAppRemoteModel, layout);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setIsPort(boolean isPort) {
		...
		if (_scienceAppRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setIsPort", boolean.class);

				method.invoke(_scienceAppRemoteModel, isPort);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setIsCompile(boolean isCompile) {
		...
		if (_scienceAppRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setIsCompile", boolean.class);

				method.invoke(_scienceAppRemoteModel, isCompile);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public String toXmlString() {
		...
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>isPort</column-name><column-value><![CDATA[");
		sb.append(getIsPort());
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>isCompile</column-name><column-value><![CDATA[");
		sb.append(getIsCompile());
		sb.append("]]></column-value></column>");
		sb.append(
