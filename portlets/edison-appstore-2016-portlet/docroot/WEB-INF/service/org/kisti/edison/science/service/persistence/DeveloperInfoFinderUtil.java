...
public class DeveloperInfoFinderUtil {
	...
	public static java.util.List<java.lang.Object[]> getDeveloperRequestStatus(
		long userId, java.lang.String[] requestStatus, int begin, int end) {
		return getFinder()
				   .getDeveloperRequestStatus(userId, requestStatus, begin, end);
	}

	public static int getCountDeveloperRequestStatus(long userId,
		java.lang.String[] requestStatus) {
		return getFinder().getCountDeveloperRequestStatus(userId, requestStatus);
	}
