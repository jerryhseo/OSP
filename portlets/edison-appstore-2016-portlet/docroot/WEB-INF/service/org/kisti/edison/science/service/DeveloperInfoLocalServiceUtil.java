...
public class DeveloperInfoLocalServiceUtil {
	...
	*/
	public static org.kisti.edison.science.model.DeveloperInfo createDeveloperInfo(
		long userId) {
		return getService().createDeveloperInfo(userId);
	}
	...
	*/
	public static org.kisti.edison.science.model.DeveloperInfo deleteDeveloperInfo(
		...
		return getService().deleteDeveloperInfo(userId);
	}
	...
	*/
	...
	public static org.kisti.edison.science.model.DeveloperInfo fetchDeveloperInfo(
		...
		return getService().fetchDeveloperInfo(userId);
	}
	...
	*/
	public static org.kisti.edison.science.model.DeveloperInfo getDeveloperInfo(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getDeveloperInfo(userId);
	}
	...
	*/
	...
	public static int getScienceAppDeveloperInfoCount(long userId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getScienceAppDeveloperInfoCount(userId);
	}
	...
	public static java.util.List<java.util.Map<java.lang.String, java.lang.Object>> getDeveloperRequestStatus(
		...
		return getService()
				   .getDeveloperRequestStatus(portalGroupId, userId,
			requestStatus, locale, begin, end);
	}

	public static int getCountDeveloperRequestStatus(long userId,
		java.lang.String[] requestStatus) {
		return getService().getCountDeveloperRequestStatus(userId, requestStatus);
	}
