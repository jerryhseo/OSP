...
public class ScienceAppFavoriteLocalServiceWrapper
	...
	*/
	...
	/**
	* 筌앸Þ爰쇽㎕�섎┛占쏙옙 �귐딅뮞占쏙옙鈺곌퀬��占싼딆뵠占쏙옙燁삳똾�믤�醫듼봺 占쎌빘苑�옙�뤿연 鈺곌퀬��     *
	...
	*/
	...
	public java.util.List<java.util.Map<java.lang.String, java.lang.Object>> getFavoriteAppList(
		...
		return _scienceAppFavoriteLocalService.getFavoriteAppList(companyGroupId,
			groupId, locale, userId);
	}
	...
	public java.util.List<java.util.Map<java.lang.String, java.lang.Object>> getFavoriteAppList(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _scienceAppFavoriteLocalService.getFavoriteAppList(categoryIds,
			locale, userId);
	}
	...
	*/
	...
	public long[] makeCategoryEntryList(long companyGroupId, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _scienceAppFavoriteLocalService.makeCategoryEntryList(companyGroupId,
			groupId);
	}
