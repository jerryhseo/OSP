...
/**
 * Provides the local service interface for DeveloperIp. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author EDISON
 * @see DeveloperIpLocalServiceUtil
...
public interface DeveloperIpLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DeveloperIpLocalServiceUtil} to access the developer ip local service. Add custom service methods to {@link org.kisti.edison.science.service.impl.DeveloperIpLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
