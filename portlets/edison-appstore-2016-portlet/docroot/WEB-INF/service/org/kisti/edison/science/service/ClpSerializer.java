...
import org.kisti.edison.science.model.ScienceAppCompileClp;
...
public class ClpSerializer {
	...
	public static Object translateInput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(ScienceAppCompileClp.class.getName())) {
			return translateInputScienceAppCompile(oldModel);
		}
		...
		if (oldModelClassName.equals(ScienceAppLogPortsClp.class.getName())) {
			return translateInputScienceAppLogPorts(oldModel);
		}
	...
	public static Object translateInputScienceAppCompile(BaseModel<?> oldModel) {
		ScienceAppCompileClp oldClpModel = (ScienceAppCompileClp)oldModel;

		BaseModel<?> newModel = oldClpModel.getScienceAppCompileRemoteModel();
	...
	public static Object translateInputScienceAppLogPorts(BaseModel<?> oldModel) {
		ScienceAppLogPortsClp oldClpModel = (ScienceAppLogPortsClp)oldModel;

		BaseModel<?> newModel = oldClpModel.getScienceAppLogPortsRemoteModel();
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"org.kisti.edison.science.model.impl.ScienceAppCompileImpl")) {
			return translateOutputScienceAppCompile(oldModel);
		}
		else if (oldModelClassName.endsWith("Clp")) {
			try {
				ClassLoader classLoader = ClpSerializer.class.getClassLoader();
		...
		if (oldModelClassName.equals(
					"org.kisti.edison.science.model.impl.ScienceAppLogPortsImpl")) {
			return translateOutputScienceAppLogPorts(oldModel);
		}
		else if (oldModelClassName.endsWith("Clp")) {
			try {
				ClassLoader classLoader = ClpSerializer.class.getClassLoader();
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
			...
			return new org.kisti.edison.science.NoSuchScienceAppCompileException();
		}
		...
		if (className.equals(
			...
			return new org.kisti.edison.science.NoSuchScienceAppLogPortsException();
		}
	...
	public static Object translateOutputScienceAppCompile(BaseModel<?> oldModel) {
		ScienceAppCompileClp newModel = new ScienceAppCompileClp();

		newModel.setModelAttributes(oldModel.getModelAttributes());

		newModel.setScienceAppCompileRemoteModel(oldModel);
	...
	public static Object translateOutputScienceAppLogPorts(
		BaseModel<?> oldModel) {
		ScienceAppLogPortsClp newModel = new ScienceAppLogPortsClp();

		newModel.setModelAttributes(oldModel.getModelAttributes());

		newModel.setScienceAppLogPortsRemoteModel(oldModel);
