...
/**
 * Provides the local service interface for CommonLib. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author EDISON
 * @see CommonLibLocalServiceUtil
...
public interface CommonLibLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CommonLibLocalServiceUtil} to access the common lib local service. Add custom service methods to {@link org.kisti.edison.science.service.impl.CommonLibLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
