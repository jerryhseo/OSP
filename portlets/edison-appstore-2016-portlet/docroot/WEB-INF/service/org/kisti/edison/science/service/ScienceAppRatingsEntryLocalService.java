...
/**
 * Provides the local service interface for ScienceAppRatingsEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author EDISON
 * @see ScienceAppRatingsEntryLocalServiceUtil
...
public interface ScienceAppRatingsEntryLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ScienceAppRatingsEntryLocalServiceUtil} to access the science app ratings entry local service. Add custom service methods to {@link org.kisti.edison.science.service.impl.ScienceAppRatingsEntryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
