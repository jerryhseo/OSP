...
/**
 * Provides the local service interface for PortTypeInputdeckForm. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author EDISON
 * @see PortTypeInputdeckFormLocalServiceUtil
...
public interface PortTypeInputdeckFormLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PortTypeInputdeckFormLocalServiceUtil} to access the port type inputdeck form local service. Add custom service methods to {@link org.kisti.edison.science.service.impl.PortTypeInputdeckFormLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
