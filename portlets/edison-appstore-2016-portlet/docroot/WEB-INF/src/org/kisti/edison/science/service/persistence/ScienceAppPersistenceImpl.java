...
public class ScienceAppPersistenceImpl extends BasePersistenceImpl<ScienceApp>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_WORKFLOWID =
		new FinderPath(ScienceAppModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { Long.class.getName() },
			ScienceAppModelImpl.WORKFLOWID_COLUMN_BITMASK |
			ScienceAppModelImpl.CREATEDATE_COLUMN_BITMASK |
			ScienceAppModelImpl.VERSION_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_WORKFLOWID = new FinderPath(ScienceAppModelImpl.ENTITY_CACHE_ENABLED,
			ScienceAppModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<ScienceApp> findByWorkflowId(long workflowId)
		throws SystemException {
	 ...
	 */
	@Override
	public List<ScienceApp> findByWorkflowId(long workflowId, int start, int end)
		throws SystemException {
	 ...
	 */
	@Override
	public List<ScienceApp> findByWorkflowId(long workflowId, int start,
		...
		if ((list != null) && !list.isEmpty()) {
			for (ScienceApp scienceApp : list) {
				if ((workflowId != scienceApp.getWorkflowId())) {
					list = null;
	 ...
	 */
	@Override
	public ScienceApp findByWorkflowId_First(long workflowId,
		OrderByComparator orderByComparator)
		throws NoSuchScienceAppException, SystemException {
		ScienceApp scienceApp = fetchByWorkflowId_First(workflowId,
				orderByComparator);
	 ...
	 */
	@Override
	public ScienceApp fetchByWorkflowId_First(long workflowId,
		OrderByComparator orderByComparator) throws SystemException {
		List<ScienceApp> list = findByWorkflowId(workflowId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public ScienceApp findByWorkflowId_Last(long workflowId,
		OrderByComparator orderByComparator)
		throws NoSuchScienceAppException, SystemException {
		ScienceApp scienceApp = fetchByWorkflowId_Last(workflowId,
				orderByComparator);
	 ...
	 */
	@Override
	public ScienceApp fetchByWorkflowId_Last(long workflowId,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<ScienceApp> list = findByWorkflowId(workflowId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public ScienceApp[] findByWorkflowId_PrevAndNext(long scienceAppId,
		long workflowId, OrderByComparator orderByComparator)
		throws NoSuchScienceAppException, SystemException {
		ScienceApp scienceApp = findByPrimaryKey(scienceAppId);
		...
		try {
			...
			array[0] = getByWorkflowId_PrevAndNext(session, scienceApp,
					workflowId, orderByComparator, true);

			array[1] = scienceApp;

			array[2] = getByWorkflowId_PrevAndNext(session, scienceApp,
	...
	protected ScienceApp getByWorkflowId_PrevAndNext(Session session,
		ScienceApp scienceApp, long workflowId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public void removeByWorkflowId(long workflowId) throws SystemException {
		for (ScienceApp scienceApp : findByWorkflowId(workflowId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(scienceApp);
		}
	}
	 ...
	 */
	@Override
	public int countByWorkflowId(long workflowId) throws SystemException {
	...
	private static final String _FINDER_COLUMN_WORKFLOWID_WORKFLOWID_2 = "scienceApp.workflowId = ?";
	...
	public ScienceApp updateImpl(
		...
		if (isNew || !ScienceAppModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((scienceAppModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						scienceAppModelImpl.getOriginalWorkflowId()
					};

				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_WORKFLOWID,
					args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_WORKFLOWID,
					args);

				args = new Object[] { scienceAppModelImpl.getWorkflowId() };
	...
	protected ScienceApp toUnwrappedModel(ScienceApp scienceApp) {
		...
		scienceAppImpl.setWorkflowId(scienceApp.getWorkflowId());
