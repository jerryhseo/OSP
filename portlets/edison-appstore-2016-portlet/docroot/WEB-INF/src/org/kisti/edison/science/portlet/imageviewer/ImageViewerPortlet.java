...
//		System.err.println(portletId);
		try 
		{
			...
			String icebreakerUrl = CustomUtil.strNull(thisGroup.getExpandoBridge().getAttribute(EdisonExpando.SITE_ICEBREAKER_URL_PUBLIC));
			...
			//Test용
			//jobUuid = "ec7e7ada-cf6f-40b5-8080-d75acdf31826";
