...
import org.kisti.edison.science.NoSuchScienceAppCategoryLinkException;
...
import org.kisti.edison.science.model.impl.ScienceAppCategoryLinkModelImpl;
...
public class ScienceAppCategoryLinkPersistenceImpl extends BasePersistenceImpl<ScienceAppCategoryLink>
	...
	public ScienceAppCategoryLink findByUuid_First(String uuid,
		...
		throws NoSuchScienceAppCategoryLinkException, SystemException {
		...
		throw new NoSuchScienceAppCategoryLinkException(msg.toString());
	}
	...
	public ScienceAppCategoryLink remove(Serializable primaryKey)
		...
		try {
			...
			if (scienceAppCategoryLink == null) {
				...
				throw new NoSuchScienceAppCategoryLinkException(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY +
					primaryKey);
			}

			return remove(scienceAppCategoryLink);
		}
		catch (NoSuchScienceAppCategoryLinkException nsee) {
			throw nsee;
		}
		catch (Exception e) {
			throw processException(e);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.org.kisti.edison.science.model.ScienceAppCategoryLink")));
