...
public class DeveloperRequestPersistenceImpl extends BasePersistenceImpl<DeveloperRequest>
	...
	/**
	 * Returns all the developer requests where userId = &#63;.
	 *
	 ...
	 */
	@Override
	public List<DeveloperRequest> findByUserId(long userId)
		throws SystemException {
		return findByUserId(userId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the developer requests where userId = &#63;.
	 *
	 * <p>
	 ...
	 */
	@Override
	public List<DeveloperRequest> findByUserId(long userId, int start, int end)
		throws SystemException {
		return findByUserId(userId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the developer requests where userId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link org.kisti.edison.science.model.impl.DeveloperRequestModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns the first developer request in the ordered set where userId = &#63;.
	 *
	 * @param userId the user ID
	 ...
	 */
	@Override
	public DeveloperRequest findByUserId_First(long userId,
	 ...
	 */
	@Override
	public DeveloperRequest fetchByUserId_First(long userId,
		OrderByComparator orderByComparator) throws SystemException {
		List<DeveloperRequest> list = findByUserId(userId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last developer request in the ordered set where userId = &#63;.
	 *
	 * @param userId the user ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public DeveloperRequest findByUserId_Last(long userId,
		OrderByComparator orderByComparator)
		throws NoSuchDeveloperRequestException, SystemException {
		DeveloperRequest developerRequest = fetchByUserId_Last(userId,
				orderByComparator);
	 ...
	 */
	@Override
	public DeveloperRequest fetchByUserId_Last(long userId,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<DeveloperRequest> list = findByUserId(userId, count - 1, count,
				orderByComparator);
	...
	/**
	 * Returns the developer requests before and after the current developer request in the ordered set where userId = &#63;.
	 *
	...
	public DeveloperRequest[] findByUserId_PrevAndNext(
		DeveloperRequestPK developerRequestPK, long userId,
		OrderByComparator orderByComparator)
		throws NoSuchDeveloperRequestException, SystemException {
	...
	protected DeveloperRequest getByUserId_PrevAndNext(Session session,
		DeveloperRequest developerRequest, long userId,
	...
	/**
	 * Removes all the developer requests where userId = &#63; from the database.
	 *
	 * @param userId the user ID
	 * @throws SystemException if a system exception occurred
	 */
	...
	public void removeByUserId(long userId) throws SystemException {
		for (DeveloperRequest developerRequest : findByUserId(userId,
	...
	/**
	 * Returns the number of developer requests where userId = &#63;.
	 *
	 * @param userId the user ID
	...
	private static final String _FINDER_COLUMN_USERID_USERID_2 = "developerRequest.id.userId = ?";
	...
	public DeveloperRequest updateImpl(
		...
		if (isNew || !DeveloperRequestModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((developerRequestModelImpl.getColumnBitmask() &
				...
				args = new Object[] { developerRequestModelImpl.getUserId() };
