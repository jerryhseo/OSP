...
import org.kisti.edison.science.NoSuchScienceAppManagerException;
import org.kisti.edison.science.model.ScienceAppManager;
import org.kisti.edison.science.model.impl.ScienceAppManagerImpl;
import org.kisti.edison.science.model.impl.ScienceAppManagerModelImpl;
...
public class ScienceAppManagerPersistenceImpl extends BasePersistenceImpl<ScienceAppManager>
	...
	public ScienceAppManager findByAppIdManagerId_First(long scienceAppId,
		...
		throws NoSuchScienceAppManagerException, SystemException {
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_APPIDANDUSERID =
		new FinderPath(ScienceAppManagerModelImpl.ENTITY_CACHE_ENABLED,
			ScienceAppManagerModelImpl.FINDER_CACHE_ENABLED,
			ScienceAppManagerImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByAppIdAndUserId",
			new String[] {
				Long.class.getName(), Long.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_APPIDANDUSERID =
		new FinderPath(ScienceAppManagerModelImpl.ENTITY_CACHE_ENABLED,
			ScienceAppManagerModelImpl.FINDER_CACHE_ENABLED,
			ScienceAppManagerImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByAppIdAndUserId",
			new String[] { Long.class.getName(), Long.class.getName() },
			ScienceAppManagerModelImpl.SCIENCEAPPID_COLUMN_BITMASK |
			ScienceAppManagerModelImpl.USERID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_APPIDANDUSERID = new FinderPath(ScienceAppManagerModelImpl.ENTITY_CACHE_ENABLED,
			ScienceAppManagerModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByAppIdAndUserId",
			new String[] { Long.class.getName(), Long.class.getName() });
	 ...
	 */
	@Override
	public List<ScienceAppManager> findByAppIdAndUserId(long scienceAppId,
		long userId) throws SystemException {
		return findByAppIdAndUserId(scienceAppId, userId, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<ScienceAppManager> findByAppIdAndUserId(long scienceAppId,
		...
		return findByAppIdAndUserId(scienceAppId, userId, start, end, null);
	}
	...
	public List<ScienceAppManager> findByAppIdAndUserId(long scienceAppId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_APPIDANDUSERID;
			finderArgs = new Object[] { scienceAppId, userId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_APPIDANDUSERID;
			finderArgs = new Object[] {
					scienceAppId, userId,
		...
		if ((list != null) && !list.isEmpty()) {
			for (ScienceAppManager scienceAppManager : list) {
				if ((scienceAppId != scienceAppManager.getScienceAppId()) ||
						(userId != scienceAppManager.getUserId())) {
					list = null;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_APPIDANDUSERID_SCIENCEAPPID_2);

			query.append(_FINDER_COLUMN_APPIDANDUSERID_USERID_2);
	 ...
	 */
	@Override
	public ScienceAppManager findByAppIdAndUserId_First(long scienceAppId,
		long userId, OrderByComparator orderByComparator)
		throws NoSuchScienceAppManagerException, SystemException {
		ScienceAppManager scienceAppManager = fetchByAppIdAndUserId_First(scienceAppId,
	 ...
	 */
	@Override
	public ScienceAppManager fetchByAppIdAndUserId_First(long scienceAppId,
		long userId, OrderByComparator orderByComparator)
		throws SystemException {
		List<ScienceAppManager> list = findByAppIdAndUserId(scienceAppId,
	 ...
	 */
	@Override
	public ScienceAppManager findByAppIdAndUserId_Last(long scienceAppId,
		long userId, OrderByComparator orderByComparator)
		throws NoSuchScienceAppManagerException, SystemException {
		ScienceAppManager scienceAppManager = fetchByAppIdAndUserId_Last(scienceAppId,
				userId, orderByComparator);
	 ...
	 */
	@Override
	public ScienceAppManager fetchByAppIdAndUserId_Last(long scienceAppId,
		long userId, OrderByComparator orderByComparator)
		throws SystemException {
		int count = countByAppIdAndUserId(scienceAppId, userId);
	 ...
	 */
	@Override
	public ScienceAppManager[] findByAppIdAndUserId_PrevAndNext(
		...
		try {
			...
			array[0] = getByAppIdAndUserId_PrevAndNext(session,
					scienceAppManager, scienceAppId, userId, orderByComparator,
					true);

			array[1] = scienceAppManager;

			array[2] = getByAppIdAndUserId_PrevAndNext(session,
					scienceAppManager, scienceAppId, userId, orderByComparator,
					false);
	...
	protected ScienceAppManager getByAppIdAndUserId_PrevAndNext(
		Session session, ScienceAppManager scienceAppManager,
		long scienceAppId, long userId, OrderByComparator orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	public void removeByAppIdAndUserId(long scienceAppId, long userId)
		throws SystemException {
		for (ScienceAppManager scienceAppManager : findByAppIdAndUserId(
				scienceAppId, userId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(scienceAppManager);
		}
	}
	...
	public int countByAppIdAndUserId(long scienceAppId, long userId)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_APPIDANDUSERID;
	...
	private static final String _FINDER_COLUMN_APPIDANDUSERID_SCIENCEAPPID_2 = "scienceAppManager.scienceAppId = ? AND ";
	private static final String _FINDER_COLUMN_APPIDANDUSERID_USERID_2 = "scienceAppManager.userId = ?";
	...
	public ScienceAppManager updateImpl(
		...
		if (isNew || !ScienceAppManagerModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((scienceAppManagerModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_APPIDANDUSERID.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						scienceAppManagerModelImpl.getOriginalScienceAppId(),
						scienceAppManagerModelImpl.getOriginalUserId()
					};

				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_APPIDANDUSERID,
					args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_APPIDANDUSERID,
					args);

				args = new Object[] {
						scienceAppManagerModelImpl.getScienceAppId(),
						scienceAppManagerModelImpl.getUserId()
					};
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.org.kisti.edison.science.model.ScienceAppManager")));
