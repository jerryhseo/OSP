...
public class RequestPopupController {
	...
	public String view(RenderRequest request, RenderResponse response,ModelMap model) {
		try {
			...
			if(parentGroupId == 0) {
				Map requestInfo = DeveloperInfoLocalServiceUtil.getCountRequestInfo(0, developerStatus, "1401001", RequiredLibConstants.LIB_STATE_REQUIRE, "1202007");	// 1202001 개발자 요청, 1401001 가상실험실 요청, RequiredLibConstants.LIB_STATE_REQUIRE 라이브러리 요청, 1202007 개발자 삭제
				...
				Map requestInfo = DeveloperInfoLocalServiceUtil.getCountRequestInfo(themeDisplay.getScopeGroupId(), developerStatus, "1401001", "", "1202007");	// 1202001 개발자 요청, 1401001 가상실험실 요청
