...
import org.kisti.edison.science.NoSuchPortTypeAnalyzerLinkException;
...
import org.kisti.edison.science.model.impl.PortTypeAnalyzerLinkModelImpl;
...
public class PortTypeAnalyzerLinkPersistenceImpl extends BasePersistenceImpl<PortTypeAnalyzerLink>
	 ...
	 */
	@Override
	public List<PortTypeAnalyzerLink> findByPortTypeId(long companyId,
		long portTypeId) throws SystemException {
		return findByPortTypeId(companyId, portTypeId, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	@Override
	public List<PortTypeAnalyzerLink> findByPortTypeId(long companyId,
		long portTypeId, int start, int end) throws SystemException {
		return findByPortTypeId(companyId, portTypeId, start, end, null);
	}
	...
	@Override
	public List<PortTypeAnalyzerLink> findByPortTypeId(long companyId,
		long portTypeId, int start, int end, OrderByComparator orderByComparator)
		throws SystemException {
		boolean pagination = true;
		FinderPath finderPath = null;
		Object[] finderArgs = null;
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			finderArgs = new Object[] { companyId, portTypeId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_PORTTYPEID;
			finderArgs = new Object[] {
					companyId, portTypeId,
		...
		if ((list != null) && !list.isEmpty()) {
			for (PortTypeAnalyzerLink portTypeAnalyzerLink : list) {
				if ((companyId != portTypeAnalyzerLink.getCompanyId()) ||
						(portTypeId != portTypeAnalyzerLink.getPortTypeId())) {
					list = null;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_PORTTYPEID_COMPANYID_2);
	 ...
	 */
	@Override
	public PortTypeAnalyzerLink findByPortTypeId_First(long companyId,
		long portTypeId, OrderByComparator orderByComparator)
		throws NoSuchPortTypeAnalyzerLinkException, SystemException {
		PortTypeAnalyzerLink portTypeAnalyzerLink = fetchByPortTypeId_First(companyId,
	 ...
	 */
	@Override
	public PortTypeAnalyzerLink fetchByPortTypeId_First(long companyId,
		long portTypeId, OrderByComparator orderByComparator)
		throws SystemException {
		List<PortTypeAnalyzerLink> list = findByPortTypeId(companyId,
				portTypeId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public PortTypeAnalyzerLink findByPortTypeId_Last(long companyId,
		long portTypeId, OrderByComparator orderByComparator)
		throws NoSuchPortTypeAnalyzerLinkException, SystemException {
		PortTypeAnalyzerLink portTypeAnalyzerLink = fetchByPortTypeId_Last(companyId,
				portTypeId, orderByComparator);
	 ...
	 */
	@Override
	public PortTypeAnalyzerLink fetchByPortTypeId_Last(long companyId,
		long portTypeId, OrderByComparator orderByComparator)
		throws SystemException {
		int count = countByPortTypeId(companyId, portTypeId);
		...
		List<PortTypeAnalyzerLink> list = findByPortTypeId(companyId,
				portTypeId, count - 1, count, orderByComparator);
	...
	public PortTypeAnalyzerLink[] findByPortTypeId_PrevAndNext(
		...
		try {
			...
			array[0] = getByPortTypeId_PrevAndNext(session,
					portTypeAnalyzerLink, companyId, portTypeId,
	...
	protected PortTypeAnalyzerLink getByPortTypeId_PrevAndNext(
		...
		long companyId, long portTypeId, OrderByComparator orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	public void removeByPortTypeId(long companyId, long portTypeId)
		...
		for (PortTypeAnalyzerLink portTypeAnalyzerLink : findByPortTypeId(
				companyId, portTypeId, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
				null)) {
			remove(portTypeAnalyzerLink);
		}
	}
	...
	public int countByPortTypeId(long companyId, long portTypeId)
		...
		Object[] finderArgs = new Object[] { companyId, portTypeId };
	...
	private static final String _FINDER_COLUMN_PORTTYPEID_COMPANYID_2 = "portTypeAnalyzerLink.companyId = ? AND ";
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.org.kisti.edison.science.model.PortTypeAnalyzerLink")));
