...
public class ConfigurationController implements ConfigurationAction  {
	...
	public void processAction(PortletConfig portletConfig, ActionRequest actionRequest, ActionResponse actionResponse)	throws Exception {
		...
		if(myAction.equals("fileSetting")){
			...
			if(!manualAddfileName.equals("")){
				EdisonFileUtil.deleteEdisonSampleFile(portalGroupId, "WORKSPACE_MANUAL");
				EdisonFileUtil.insertEdisonSampleFile(actionRequest, upload, userId, portalGroupId, "manualAddfile", "WORKSPACE_MANUAL");
			}
			
			String securityAddfileName = CustomUtil.strNull(upload.getFileName("securityAddfile"));
			if(!securityAddfileName.equals("")){
				EdisonFileUtil.deleteEdisonSampleFile(portalGroupId, "WORKSPACE_SECURITY");
				EdisonFileUtil.insertEdisonSampleFile(actionRequest, upload, userId, portalGroupId, "securityAddfile", "WORKSPACE_SECURITY");
			}
		}
	}
	...
	public String render(PortletConfig portletConfig, RenderRequest renderRequest,
		...
		manualFileList = EdisonFileUtil.getListEdisonSampleFile(portalGroupId, "WORKSPACE_MANUAL");
		List securityFileList = null;
		securityFileList = EdisonFileUtil.getListEdisonSampleFile(portalGroupId, "WORKSPACE_SECURITY");
