...
public class PortTypeAnalyzerLinkLocalServiceImpl
  ...
  public List<Map<String, Object>> findByPortTypeId(long portTypeId, Locale locale) throws SystemException{
    List<Map<String, Object>> portTypeAnalyzerLinks = new ArrayList<Map<String, Object>>();
    List<Object[]> analyzerArrays = portTypeAnalyzerLinkFinder.retrieveListPortTypeAnalyzerLink(portTypeId);
    if(analyzerArrays != null) {
      for(Object[] analyzerArray : analyzerArrays){
        Map<String, Object> portTypeAnalyzerLinkScienceApp = new HashMap<String, Object>();
        PortTypeAnalyzerLink portTypeAnalyzerLink = (PortTypeAnalyzerLink)analyzerArray[0];
        ScienceApp scienceApp = (ScienceApp)analyzerArray[1];
        portTypeAnalyzerLinkScienceApp.putAll(portTypeAnalyzerLink.getModelAttributes());
        portTypeAnalyzerLinkScienceApp.putAll(scienceApp.getModelAttributes());
        portTypeAnalyzerLinkScienceApp.put("title", scienceApp.getTitle(locale)); 
        portTypeAnalyzerLinks.add(portTypeAnalyzerLinkScienceApp);
      }
      return portTypeAnalyzerLinks;
    } else {
      return null;
    }
  }
