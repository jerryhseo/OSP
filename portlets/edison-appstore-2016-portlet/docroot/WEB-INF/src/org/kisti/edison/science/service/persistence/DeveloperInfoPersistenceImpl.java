...
public class DeveloperInfoPersistenceImpl extends BasePersistenceImpl<DeveloperInfo>
	...
	private static final String _FINDER_COLUMN_USERID_USERID_2 = "developerInfo.userId = ?";
	 ...
	 */
	@Override
	public DeveloperInfo remove(long userId)
		throws NoSuchDeveloperInfoException, SystemException {
	 ...
	 */
	@Override
	public DeveloperInfo findByPrimaryKey(long userId)
		throws NoSuchDeveloperInfoException, SystemException {
	 ...
	 */
	@Override
	public DeveloperInfo fetchByPrimaryKey(long userId)
		throws SystemException {
