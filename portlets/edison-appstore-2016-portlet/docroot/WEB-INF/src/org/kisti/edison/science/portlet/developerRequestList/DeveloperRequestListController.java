...
public class DeveloperRequestListController {
	...
	public void developerRequestList(ResourceRequest request, ResourceResponse response) throws SystemException, IOException, PortalException {
		...
		String workspaceStats[] = {
				"1202001", "1202004", "1202007"
		};
		
		long portalGroupId = themeDisplay.getScopeGroupId();
		...
		List<Map<String, Object>> developerRequestList = DeveloperInfoLocalServiceUtil.getDeveloperRequestStatus(portalGroupId, 0, workspaceStats, locale, begin, linePerPage);
		int developerRequestCount = DeveloperInfoLocalServiceUtil.getCountDeveloperRequestStatus(0, workspaceStats);
