...
%>
	...
	<div class="conwrap2">
		...
		<div class="conwrap2right">
			...
			<!--리스트-->
			<div class="qalist">
				<ul id="<portlet:namespace/>qnaList_ul">
				</ul>
			</div>
		</div>
		
		<div class="noticetit" style="display: none;"> 
			<img src="${contextPath}/images/readmoreimg.gif" width="25" height="25" onclick="goList<portlet:namespace/>('${maxWindowStatus}');" style="cursor: pointer;"/>
		</div>
	</div>
			...
			success: function(data) {
				...
				if(boardList.length == 0){
					...
					for(var i = 0 ; i < boardList.length; i++ ){
						...
						/* 질문 */
						var questionIcon = $("<input/>").addClass("btn_s_q")
														.attr("type", "button")
