...
import org.kisti.edison.login.NoSuchLoginLogException;
import org.kisti.edison.login.model.LoginLog;
import org.kisti.edison.login.model.impl.LoginLogImpl;
import org.kisti.edison.login.model.impl.LoginLogModelImpl;
...
public class LoginLogPersistenceImpl extends BasePersistenceImpl<LoginLog>
	 ...
	 */
	@Override
	public LoginLog create(long id) {
		LoginLog loginLog = new LoginLogImpl();

		loginLog.setNew(true);
		loginLog.setPrimaryKey(id);
	 ...
	 */
	@Override
	public LoginLog remove(long id)
	...
	@Override
	public LoginLog updateImpl(org.kisti.edison.login.model.LoginLog loginLog)
	...
	protected LoginLog toUnwrappedModel(LoginLog loginLog) {
		...
		loginLogImpl.setId(loginLog.getId());
	 ...
	 */
	@Override
	public LoginLog findByPrimaryKey(long id)
		throws NoSuchLoginLogException, SystemException {
	 ...
	 */
	@Override
	public LoginLog fetchByPrimaryKey(long id) throws SystemException {
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.org.kisti.edison.login.model.LoginLog")));
