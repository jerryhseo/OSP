...
/**
 * Provides the local service interface for LoginLog. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author yjpark
 * @see LoginLogLocalServiceUtil
...
public interface LoginLogLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LoginLogLocalServiceUtil} to access the login log local service. Add custom service methods to {@link org.kisti.edison.login.service.impl.LoginLogLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
