...
<%
	...
	if(isLogin){
		...
		isSiteOwner = EdisonUserUtil.isSiteRole(themeDisplay.getUser(), themeDisplay.getScopeGroupId(), EdisonRoleConstants.SITE_OWNER);
...
<c:set var="isSiteOwner" value="<%=isSiteOwner %>" scope="page" />
...
<liferay-ui:success key="<%=EdisonMessageConstants.BATCH_EXECUTE_SUCCESS%>" message="edion-batch-execute-success"/>
...
<liferay-ui:success key="<%=EdisonMessageConstants.BATCH_EXECUTE_ERROR%>" message="edion-batch-execute-error"/>