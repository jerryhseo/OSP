...
public class WorkflowInstanceWrapper implements WorkflowInstance,
	...
	*/
	...
	/**
	* Returns the status response of this workflow instance.
	*
	* @return the status response of this workflow instance
	*/
	@Override
	public java.lang.String getStatusResponse() {
		return _workflowInstance.getStatusResponse();
	}

	/**
	* Sets the status response of this workflow instance.
	*
	* @param statusResponse the status response of this workflow instance
	*/
	@Override
	public void setStatusResponse(java.lang.String statusResponse) {
		_workflowInstance.setStatusResponse(statusResponse);
	}
