...
public class WorkflowInstanceClp extends BaseModelImpl<WorkflowInstance>
	...
	public void setStatusResponse(String statusResponse) {
		...
		if (_workflowInstanceRemoteModel != null) {
			try {
				...
				method.invoke(_workflowInstanceRemoteModel, statusResponse);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public int compareTo(WorkflowInstance workflowInstance) {
		...
		if (getWorkflowInstanceId() < workflowInstance.getWorkflowInstanceId()) {
			value = -1;
		}
		else if (getWorkflowInstanceId() > workflowInstance.getWorkflowInstanceId()) {
			value = 1;
		}
		else {
			value = 0;
