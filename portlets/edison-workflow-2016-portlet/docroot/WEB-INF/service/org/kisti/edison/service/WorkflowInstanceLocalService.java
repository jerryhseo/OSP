...
/**
 * Provides the local service interface for WorkflowInstance. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author EDISON
 * @see WorkflowInstanceLocalServiceUtil
...
public interface WorkflowInstanceLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WorkflowInstanceLocalServiceUtil} to access the workflow instance local service. Add custom service methods to {@link org.kisti.edison.service.impl.WorkflowInstanceLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
