...
public class WorkflowBeanUtil{
    ...
    public static long specificSiteGroupId(PortletRequest request) throws SystemException{
        ...
        List<Group> groupList = CustomUtil
            .getGroupIdASC(GroupLocalServiceUtil.getGroups(companyId, parentGroup.getGroupId(), true));
        return groupList.size() > 0 ? groupList.get(0).getGroupId() : 0;
    }

    public static List<Map<String, Object>> transformToModelAttributes(List<?> models) throws EdisonWorkflowException{
    ...
    public static Map<String, Object> scienceAppToJstreeModel(ScienceApp scienceApp, Locale locale, long categoryId){
    ...
    public static List<Map<String, Object>> assetCategoryToJstreeModel(List<AssetCategory> assetCategories,
        Locale locale){
        List<Map<String, Object>> result = new ArrayList<Map<String, Object>>();
    ...
    public static Map<String, Object> assetCategoryToJstreeModel(AssetCategory assetCategory, Locale locale){
    ...
    public static List<Map<String, Object>> groupToJstreeModel(List<Group> groups, Locale locale){
        List<Map<String, Object>> result = new ArrayList<Map<String, Object>>();
    ...
    public static Map<String, Object> groupToJstreeModel(Group group, Locale locale){
    ...
    public static List<Map<String, Object>> workflowToJstreeModel(List<Workflow> workflows, Locale locale){
        List<Map<String, Object>> result = new ArrayList<Map<String, Object>>();
    ...
    public static List<Map<String, Object>> workflowMapToJstreeModel(List<Map<String, Object>> workflows,
        Locale locale){
        List<Map<String, Object>> result = new ArrayList<Map<String, Object>>();
