...
public class WorkflowController{
  ...
  public @ResponseBody String intermediateLog(
      @RequestParam(value="accessToken") String ibAccessToken, 
      @PathVariable("jobUUID") String jobUUID,
      HttpServletRequest request)
          throws Exception{
    try{
      return WorkflowLocalServiceUtil.getWorkflowJobIntermediateResult(jobUUID, ibAccessToken).replaceAll("[\"\']", " ");
    }catch (Exception e){
      log.error("error", e);
      throw e;
    }
  ...
  public @ResponseBody String simulationLog(
      ...
      HttpServletRequest request)
          throws Exception{
    try{
      return WorkflowLocalServiceUtil.getWorkflowSimulationLog(workflowUUID, simulationUUID, ibAccessToken).replaceAll("[\"\']", " ");
    }catch (Exception e){
      log.error("error", e);
      throw e;
    }
  ...
  public @ResponseBody String simulationErrorLog(
      ...
      HttpServletRequest request)
          throws Exception{
    try{
      return WorkflowLocalServiceUtil.getWorkflowSimulationErrorLog(workflowUUID, simulationUUID, ibAccessToken).replaceAll("[\"\']", " ");
    }catch (Exception e){
      log.error("error", e);
      throw e;
    }
