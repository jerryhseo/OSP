...
public class WorkflowSimulationLocalServiceImpl extends WorkflowSimulationLocalServiceBaseImpl{
    ...
    public int getCountWorkflowSimulations(String title, long userId) throws SystemException {
        if(StringUtils.hasText(title)) {
            return workflowSimulationPersistence.countByTitle_UserId(title, userId);    
        }
