...
public class WorkflowInstanceModelImpl extends BaseModelImpl<WorkflowInstance>
	...
	public static long WORKFLOWINSTANCEID_COLUMN_BITMASK = 4L;
	...
	public Object clone() {
		...
		workflowInstanceImpl.setStatusResponse(getStatusResponse());
	...
	public CacheModel<WorkflowInstance> toCacheModel() {
		...
		workflowInstanceCacheModel.statusResponse = getStatusResponse();

		String statusResponse = workflowInstanceCacheModel.statusResponse;

		if ((statusResponse != null) && (statusResponse.length() == 0)) {
			workflowInstanceCacheModel.statusResponse = null;
		}
