...
//			surveyQuestion.setQuestion10(CustomUtil.strNull(params.get("question10")), Locale.US);
	...
	public List<Map<String, Object>> getSurveyQuestionResult(long surveySeqNo, long virtualLabId, long classId, long groupId, Locale locale) {
	  return getSurveyQuestionResult(surveySeqNo, virtualLabId, classId, groupId, locale,
        null, null);
	}
	
  public List<Map<String, Object>> getSurveyQuestionResult(long surveySeqNo, long virtualLabId,
      long classId, long groupId, Locale locale, String answerStartDate, String answerEndDate){
		List<Map<String,Object>> returnList = new ArrayList<Map<String, Object>>();
		
    List<Object[]> resultList = surveyFinder.getSurveyQuestion(surveySeqNo, virtualLabId, classId,
        groupId, answerStartDate, answerEndDate);
