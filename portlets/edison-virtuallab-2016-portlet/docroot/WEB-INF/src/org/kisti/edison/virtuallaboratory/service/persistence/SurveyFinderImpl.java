...
public class SurveyFinderImpl extends BasePersistenceImpl<Survey> implements SurveyFinder{
  ...
  public List<Object[]> getSurveyQuestion(long surveySeqNo, long virtualLabId, long classId,
      long groupId, String answerStartDate, String answerEndDate){
    Session session = openSession();
    try{
      String sqlQuery = CustomSQLUtil
          .get("org.kisti.edison.service.persistence.Survey.getSurveyQuestionResult");
      ...
      if(StringUtils.hasText(answerStartDate)){
        params.put("answerStartDate", answerStartDate);
      }
      if(StringUtils.hasText(answerEndDate)){
        params.put("answerEndDate", answerEndDate);
      }

      String gBatisQuery = GBatisUtil.getGBatis(params, sqlQuery);
      SQLQuery query = session.createSQLQuery(gBatisQuery);
      query.addEntity("EDVIR_SurveyQuestion", SurveyQuestionImpl.class);
      query.addScalar("questionCnt", Type.INTEGER);
	...
	public List<Object[]> getSurveyQuestion(long surveySeqNo, long virtualLabId, long classId, long groupId) {
	  return getSurveyQuestion(surveySeqNo, virtualLabId, classId, groupId, null, null);
	}
	...
	public List<Object[]> getSurveyResultList(long groupId, long surveySeqNo, String searchField, String searchUniversityField, int begin, int end, Locale locale) {
		Session session=openSession();
	...
	public Integer getCountSurveyResultList(long groupId, long surveySeqNo, String searchField, String searchUniversityField, Locale locale) {
		Session session=openSession();
