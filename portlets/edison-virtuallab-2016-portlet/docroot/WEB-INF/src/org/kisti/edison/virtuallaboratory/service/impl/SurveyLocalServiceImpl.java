...
public class SurveyLocalServiceImpl extends SurveyLocalServiceBaseImpl {
	...
	public List<Map<String, Object>> getSurveyResultList(long groupId, long surveySeqNo, String searchField, int begin, int end, Locale locale) throws SystemException, PortalException {
		...
		List<Object[]> surveyResultList = surveyFinder.getSurveyResultList(groupId, surveySeqNo, searchField, searchUniversityField, begin, end, locale);
	...
	public int getCountSurveyResultList(long groupId, long surveySeqNo, String searchField, Locale locale) throws SystemException {
		...
		return surveyFinder.getCountSurveyResultList(groupId, surveySeqNo, searchField, searchUniversityField, locale);
	}
