...
public class VirtualLabClassScienceAppLocalServiceClpInvoker {
	public VirtualLabClassScienceAppLocalServiceClpInvoker() {
		...
		_methodName142 = "getVirtualLabScienceAppList";

		_methodParameterTypes142 = new String[] {
				"long", "long", "long", "java.util.Locale"
			};

		_methodName143 = "getVirtualLabClassScienceAppList";

		_methodParameterTypes143 = new String[] {
				"long", "long", "long", "java.util.Locale"
			};

		_methodName144 = "getScienceAppList";

		_methodParameterTypes144 = new String[] { "long", "java.lang.String" };

		_methodName145 = "insertVirtualLabScienceAppList";

		_methodParameterTypes145 = new String[] {
				"long", "long", "long", "java.lang.Object", "java.util.Locale"
			};

		_methodName146 = "insertVirtualLabClassScienceAppList";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName142.equals(name) &&
			...
			return VirtualLabClassScienceAppLocalServiceUtil.getVirtualLabScienceAppList(((Long)arguments[0]).longValue(),
				((Long)arguments[1]).longValue(),
		...
		if (_methodName145.equals(name) &&
			...
			VirtualLabClassScienceAppLocalServiceUtil.insertVirtualLabScienceAppList(((Long)arguments[0]).longValue(),
				((Long)arguments[1]).longValue(),
