...
public class VirtualClassManagementController {
	...
	public String view(RenderRequest request, RenderResponse response, ModelMap model) {
		try {
			...
			long groupId_ = themeDisplay.getSiteGroupId();
			...
			long classPlid = PortalUtil.getPlidFromPortletId(groupId_, "edisonvirtuallabmanagementlist_WAR_edisonvirtuallab2016portlet");
