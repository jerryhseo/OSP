...
public class VirtualLabClassLocalServiceClpInvoker {
	public VirtualLabClassLocalServiceClpInvoker() {
		...
		_methodName174 = "getVirtualClassMainVisual";

		_methodParameterTypes174 = new String[] { "long", "java.util.Locale" };

		_methodName175 = "getVirtualLabClassInfo";

		_methodParameterTypes175 = new String[] { "long", "java.util.Locale" };

		_methodName176 = "getVirtualClassList";

		_methodParameterTypes176 = new String[] {
				"java.util.Map", "java.util.Locale"
			};

		_methodName177 = "getVirtualClassListCount";

		_methodParameterTypes177 = new String[] { "java.util.Map" };

		_methodName178 = "insertVirtualLabClass";

		_methodParameterTypes178 = new String[] {
				"java.util.Map", "java.util.Locale"
			};

		_methodName179 = "getListVirtualLabClassManagement";

		_methodParameterTypes179 = new String[] {
				"java.util.Map", "java.util.Locale"
			};

		_methodName180 = "getListVirtualLabClass";

		_methodParameterTypes180 = new String[] {
				"java.util.Map", "java.util.Locale"
			};

		_methodName181 = "getVirtualLabClassList";

		_methodParameterTypes181 = new String[] {
				"java.util.Map", "java.util.Locale"
			};

		_methodName182 = "getCountVirtualLabManagementClass";

		_methodParameterTypes182 = new String[] {
				"java.util.Map", "java.util.Locale"
			};

		_methodName183 = "getCountVirtualLabClass";

		_methodParameterTypes183 = new String[] {
				"java.util.Map", "java.util.Locale"
			};

		_methodName184 = "getCountVirtualLabClassList";

		_methodParameterTypes184 = new String[] {
				"java.util.Map", "java.util.Locale"
			};

		_methodName185 = "updateVirtualLabClassDisable";

		_methodParameterTypes185 = new String[] { "long", "java.lang.String" };

		_methodName186 = "getVirtualClassBoardSeqList";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName179.equals(name) &&
			...
			return VirtualLabClassLocalServiceUtil.getListVirtualLabClassManagement((java.util.Map<java.lang.String, java.lang.Object>)arguments[0],
				(java.util.Locale)arguments[1]);
		}
		...
		if (_methodName181.equals(name) &&
			...
			return VirtualLabClassLocalServiceUtil.getVirtualLabClassList((java.util.Map<java.lang.String, java.lang.Object>)arguments[0],
				(java.util.Locale)arguments[1]);
		}

		if (_methodName182.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes182, parameterTypes)) {
			return VirtualLabClassLocalServiceUtil.getCountVirtualLabManagementClass((java.util.Map<java.lang.String, java.lang.Object>)arguments[0],
				(java.util.Locale)arguments[1]);
		}
		...
		if (_methodName184.equals(name) &&
			...
			return VirtualLabClassLocalServiceUtil.getCountVirtualLabClassList((java.util.Map<java.lang.String, java.lang.Object>)arguments[0],
				(java.util.Locale)arguments[1]);
		}
