...
public class SurveyResultListController {
	...
	public void getListSurveyResult(ResourceRequest request, ResourceResponse response){
			ThemeDisplay themeDisplay = (ThemeDisplay) request.getAttribute(WebKeys.THEME_DISPLAY);
			Locale locale = themeDisplay.getLocale();
		try {
  ...
  public String surveyResultView(RenderRequest request, RenderResponse response, ModelMap model){
    try{
      ...
      Map<String, Object> surveyMap 
        = SurveyLocalServiceUtil.getSurveyInfomation(surveySeqNo, locale);
      List<Map<String, Object>> surveyQuestionList
        = SurveyQuestionLocalServiceUtil.getSurveyQuestionInfomation(surveySeqNo, locale);
	...
	public void surveyQuestionList(ResourceRequest request, ResourceResponse response)  throws PortalException, SystemException, IOException, SQLException{
		...
		String answerStartDate = ParamUtil.getString(request, "answerStartDate", "");
    String answerEndDate = ParamUtil.getString(request, "answerEndDate", "");
		
    List<Map<String, Object>> jobList = SurveyQuestionLocalServiceUtil
        .getSurveyQuestionResult(surveySeqNo, virtualLabId, classId, groupId, locale,
            answerStartDate, answerEndDate);
	...
	public void surveyAnswerList(ResourceRequest request, ResourceResponse response)  throws PortalException, SystemException, IOException, SQLException{
		...
		List<Map<String, Object>>  jobList = SurveyQuestionLocalServiceUtil.getSurveyQuestionSubject(
		    surveySeqNo, virtualLabId, classId, questionDivCd, questionSeqNo, groupId);
		json = JSONArray.fromObject(JSONSerializer.toJSON(jobList));
