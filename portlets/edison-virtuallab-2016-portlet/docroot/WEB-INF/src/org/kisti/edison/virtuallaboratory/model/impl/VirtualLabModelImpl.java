...
public class VirtualLabModelImpl extends BaseModelImpl<VirtualLab>
	...
	public Object clone() {
		...
		virtualLabImpl.setIconId(getIconId());
		virtualLabImpl.setProfessorSeq(getProfessorSeq());
	...
	public CacheModel<VirtualLab> toCacheModel() {
		...
		virtualLabCacheModel.iconId = getIconId();

		virtualLabCacheModel.professorSeq = getProfessorSeq();
