...
public class VirtualLabLocalServiceWrapper implements VirtualLabLocalService,
	...
	*/
	...
	public org.kisti.edison.virtuallaboratory.model.VirtualLab addVirtualLab(
		...
		return _virtualLabLocalService.addVirtualLab(upload, request, groupId,
			userId, param, locale);
	}
	...
	public java.util.List<java.util.Map<java.lang.String, java.lang.Object>> getListVirtualLabManagement(
		...
		java.util.Locale locale)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _virtualLabLocalService.getListVirtualLabManagement(params,
			locale);
	}
	...
	public java.util.List<java.util.Map<java.lang.String, java.lang.Object>> getVirtualLabGroup()
		throws com.liferay.portal.kernel.exception.SystemException {
		return _virtualLabLocalService.getVirtualLabGroup();
	}
	...
	* 揶쏅벡伊��귐딅뮞占쏙옙鈺곌퀬��占쎈��믭옙�븝옙 占쎄쑴��占쎌쥙彛�疫꿸퀣占쏙옙�곗쨮 6揶쏆뮇�∽옙�됰퓠 占싼뗫맙占쏙옙占쎄퀣�좑옙占�     */
	...
	public java.util.List<java.util.Map<java.lang.String, java.lang.Object>> getVirtualLabList(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _virtualLabLocalService.getVirtualLabList(params, locale);
	}
	...
	public java.util.List<java.util.Map<java.lang.String, java.lang.Object>> getVirtualLabTabList(
		...
		java.util.Locale locale)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _virtualLabLocalService.getVirtualLabTabList(params, locale);
	}
	...
	public int getCountVirtualLabClassRegisterList(long groupId, long userId,
		java.util.Locale locale) {
		return _virtualLabLocalService.getCountVirtualLabClassRegisterList(groupId,
			userId, locale);
	}
	...
	public int getCountVirtualLabList(
		java.util.Map<java.lang.String, java.lang.Object> params,
		java.util.Locale locale) {
		return _virtualLabLocalService.getCountVirtualLabList(params, locale);
	}
	...
	public org.kisti.edison.virtuallaboratory.model.VirtualLab updateVirtualLabInfomation(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			...
			org.kisti.edison.virtuallaboratory.NoSuchVirtualLabException {
		return _virtualLabLocalService.updateVirtualLabInfomation(upload,
			request, groupId, userId, params, locale);
	}
