...
public class VirtualLabLocalServiceUtil {
	...
	*/
	...
	public static org.kisti.edison.virtuallaboratory.model.VirtualLab addVirtualLab(
		...
		return getService()
				   .addVirtualLab(upload, request, groupId, userId, param,
			locale);
	}
	...
	public static java.util.List<java.util.Map<java.lang.String, java.lang.Object>> getListVirtualLabManagement(
		java.util.Map<java.lang.String, java.lang.Object> params,
		java.util.Locale locale)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getListVirtualLabManagement(params, locale);
	}

	public static java.util.List<java.util.Map<java.lang.String, java.lang.Object>> getVirtualLabGroup()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getVirtualLabGroup();
	}

	/**
	* 강좌 리스트 조회(클래스가 현재 날짜 기준으로 6개월안에 포함된 데이터)
	*/
	public static java.util.List<java.util.Map<java.lang.String, java.lang.Object>> getVirtualLabList(
		java.util.Map<java.lang.String, java.lang.Object> params,
		java.util.Locale locale)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getVirtualLabList(params, locale);
	}

	public static java.util.List<java.util.Map<java.lang.String, java.lang.Object>> getVirtualLabTabList(
		java.util.Map<java.lang.String, java.lang.Object> params,
		java.util.Locale locale)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getVirtualLabTabList(params, locale);
	}
	...
	public static int getCountVirtualLabList(
		java.util.Map<java.lang.String, java.lang.Object> params,
		java.util.Locale locale) {
		return getService().getCountVirtualLabList(params, locale);
	}
	...
	public static org.kisti.edison.virtuallaboratory.model.VirtualLab updateVirtualLabInfomation(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			...
			org.kisti.edison.virtuallaboratory.NoSuchVirtualLabException {
		return getService()
				   .updateVirtualLabInfomation(upload, request, groupId,
			userId, params, locale);
	}
