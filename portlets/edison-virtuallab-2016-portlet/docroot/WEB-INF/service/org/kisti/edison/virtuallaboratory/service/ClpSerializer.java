...
import org.kisti.edison.virtuallaboratory.model.ClassNoteClp;
import org.kisti.edison.virtuallaboratory.model.ProfessorClp;
...
import org.kisti.edison.virtuallaboratory.model.VirtualLabClassStsMigrationClp;
import org.kisti.edison.virtuallaboratory.model.VirtualLabClp;
import org.kisti.edison.virtuallaboratory.model.VirtualLabScienceAppLinkClassClp;
import org.kisti.edison.virtuallaboratory.model.VirtualLabScienceAppLinkClp;
...
public class ClpSerializer {
	...
	public static Object translateInput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(ClassNoteClp.class.getName())) {
			return translateInputClassNote(oldModel);
		}

		if (oldModelClassName.equals(ProfessorClp.class.getName())) {
			return translateInputProfessor(oldModel);
		}
		...
		if (oldModelClassName.equals(
					VirtualLabClassStsMigrationClp.class.getName())) {
			return translateInputVirtualLabClassStsMigration(oldModel);
		}

		if (oldModelClassName.equals(
					VirtualLabScienceAppLinkClp.class.getName())) {
			return translateInputVirtualLabScienceAppLink(oldModel);
		}

		if (oldModelClassName.equals(
					VirtualLabScienceAppLinkClassClp.class.getName())) {
			return translateInputVirtualLabScienceAppLinkClass(oldModel);
		}
	...
	public static Object translateInputClassNote(BaseModel<?> oldModel) {
		ClassNoteClp oldClpModel = (ClassNoteClp)oldModel;

		BaseModel<?> newModel = oldClpModel.getClassNoteRemoteModel();
	...
	public static Object translateInputProfessor(BaseModel<?> oldModel) {
		ProfessorClp oldClpModel = (ProfessorClp)oldModel;

		BaseModel<?> newModel = oldClpModel.getProfessorRemoteModel();
	...
	public static Object translateInputVirtualLabClassStsMigration(
		BaseModel<?> oldModel) {
		VirtualLabClassStsMigrationClp oldClpModel = (VirtualLabClassStsMigrationClp)oldModel;

		BaseModel<?> newModel = oldClpModel.getVirtualLabClassStsMigrationRemoteModel();
	...
	public static Object translateInputVirtualLabScienceAppLink(
		BaseModel<?> oldModel) {
		VirtualLabScienceAppLinkClp oldClpModel = (VirtualLabScienceAppLinkClp)oldModel;

		BaseModel<?> newModel = oldClpModel.getVirtualLabScienceAppLinkRemoteModel();
	...
	public static Object translateInputVirtualLabScienceAppLinkClass(
		BaseModel<?> oldModel) {
		VirtualLabScienceAppLinkClassClp oldClpModel = (VirtualLabScienceAppLinkClassClp)oldModel;

		BaseModel<?> newModel = oldClpModel.getVirtualLabScienceAppLinkClassRemoteModel();
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"org.kisti.edison.virtuallaboratory.model.impl.ClassNoteImpl")) {
			return translateOutputClassNote(oldModel);
		}
		...
		if (oldModelClassName.equals(
					"org.kisti.edison.virtuallaboratory.model.impl.ProfessorImpl")) {
			return translateOutputProfessor(oldModel);
		}
		else if (oldModelClassName.endsWith("Clp")) {
			try {
				ClassLoader classLoader = ClpSerializer.class.getClassLoader();
		...
		if (oldModelClassName.equals(
					"org.kisti.edison.virtuallaboratory.model.impl.VirtualLabClassStsMigrationImpl")) {
			return translateOutputVirtualLabClassStsMigration(oldModel);
		}
		else if (oldModelClassName.endsWith("Clp")) {
			try {
				ClassLoader classLoader = ClpSerializer.class.getClassLoader();
		...
		if (oldModelClassName.equals(
					"org.kisti.edison.virtuallaboratory.model.impl.VirtualLabScienceAppLinkImpl")) {
			return translateOutputVirtualLabScienceAppLink(oldModel);
		}
		else if (oldModelClassName.endsWith("Clp")) {
			try {
				ClassLoader classLoader = ClpSerializer.class.getClassLoader();
		...
		if (oldModelClassName.equals(
					"org.kisti.edison.virtuallaboratory.model.impl.VirtualLabScienceAppLinkClassImpl")) {
			return translateOutputVirtualLabScienceAppLinkClass(oldModel);
		}
		else if (oldModelClassName.endsWith("Clp")) {
			try {
				ClassLoader classLoader = ClpSerializer.class.getClassLoader();
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
			...
			return new org.kisti.edison.virtuallaboratory.NoSuchClassNoteException();
		}

		if (className.equals(
					"org.kisti.edison.virtuallaboratory.NoSuchProfessorException")) {
			return new org.kisti.edison.virtuallaboratory.NoSuchProfessorException();
		}
		...
		if (className.equals(
			...
			return new org.kisti.edison.virtuallaboratory.NoSuchVirtualLabClassStsMigrationException();
		}

		if (className.equals(
					"org.kisti.edison.virtuallaboratory.NoSuchVirtualLabScienceAppLinkException")) {
			return new org.kisti.edison.virtuallaboratory.NoSuchVirtualLabScienceAppLinkException();
		}

		if (className.equals(
					"org.kisti.edison.virtuallaboratory.NoSuchVirtualLabScienceAppLinkClassException")) {
			return new org.kisti.edison.virtuallaboratory.NoSuchVirtualLabScienceAppLinkClassException();
		}
	...
	public static Object translateOutputClassNote(BaseModel<?> oldModel) {
		ClassNoteClp newModel = new ClassNoteClp();

		newModel.setModelAttributes(oldModel.getModelAttributes());

		newModel.setClassNoteRemoteModel(oldModel);

		return newModel;
	}

	public static Object translateOutputProfessor(BaseModel<?> oldModel) {
		ProfessorClp newModel = new ProfessorClp();

		newModel.setModelAttributes(oldModel.getModelAttributes());

		newModel.setProfessorRemoteModel(oldModel);
	...
	public static Object translateOutputVirtualLabClassStsMigration(
		BaseModel<?> oldModel) {
		VirtualLabClassStsMigrationClp newModel = new VirtualLabClassStsMigrationClp();

		newModel.setModelAttributes(oldModel.getModelAttributes());

		newModel.setVirtualLabClassStsMigrationRemoteModel(oldModel);

		return newModel;
	}

	public static Object translateOutputVirtualLabScienceAppLink(
		BaseModel<?> oldModel) {
		VirtualLabScienceAppLinkClp newModel = new VirtualLabScienceAppLinkClp();

		newModel.setModelAttributes(oldModel.getModelAttributes());

		newModel.setVirtualLabScienceAppLinkRemoteModel(oldModel);

		return newModel;
	}

	public static Object translateOutputVirtualLabScienceAppLinkClass(
		BaseModel<?> oldModel) {
		VirtualLabScienceAppLinkClassClp newModel = new VirtualLabScienceAppLinkClassClp();

		newModel.setModelAttributes(oldModel.getModelAttributes());

		newModel.setVirtualLabScienceAppLinkClassRemoteModel(oldModel);
