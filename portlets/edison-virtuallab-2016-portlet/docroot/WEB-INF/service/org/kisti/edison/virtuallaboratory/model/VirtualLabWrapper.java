...
public class VirtualLabWrapper implements VirtualLab, ModelWrapper<VirtualLab> {
	...
	*/
	...
	/**
	* Returns the icon ID of this virtual lab.
	*
	* @return the icon ID of this virtual lab
	*/
	@Override
	public long getIconId() {
		return _virtualLab.getIconId();
	}

	/**
	* Sets the icon ID of this virtual lab.
	*
	* @param iconId the icon ID of this virtual lab
	*/
	@Override
	public void setIconId(long iconId) {
		_virtualLab.setIconId(iconId);
	}

	/**
	* Returns the professor seq of this virtual lab.
	*
	* @return the professor seq of this virtual lab
	*/
	@Override
	public long getProfessorSeq() {
		return _virtualLab.getProfessorSeq();
	}

	/**
	* Sets the professor seq of this virtual lab.
	*
	* @param professorSeq the professor seq of this virtual lab
	*/
	@Override
	public void setProfessorSeq(long professorSeq) {
		_virtualLab.setProfessorSeq(professorSeq);
	}
