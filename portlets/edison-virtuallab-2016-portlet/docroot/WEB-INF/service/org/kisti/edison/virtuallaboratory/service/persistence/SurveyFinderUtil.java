...
public class SurveyFinderUtil {
	...
	public static java.util.List<java.lang.Object[]> getSurveyQuestion(
		...
		java.lang.String answerStartDate, java.lang.String answerEndDate) {
		return getFinder()
	...
	public static java.util.List<java.lang.Object[]> getSurveyResultList(
		...
		java.lang.String searchUniversityField, int begin, int end,
		java.util.Locale locale) {
		return getFinder()
				   .getSurveyResultList(groupId, surveySeqNo, searchField,
			searchUniversityField, begin, end, locale);
	}

	public static java.lang.Integer getCountSurveyResultList(long groupId,
		long surveySeqNo, java.lang.String searchField,
		java.lang.String searchUniversityField, java.util.Locale locale) {
		return getFinder()
				   .getCountSurveyResultList(groupId, surveySeqNo, searchField,
			searchUniversityField, locale);
	}
