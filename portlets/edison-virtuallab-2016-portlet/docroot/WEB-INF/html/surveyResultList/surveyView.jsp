...
<form name="surveyForm" action="<%=updateURL %>" method="post">		
	...
	<div id="data_text_wrap" class="surveyMain table-responsive panel edison-panel ">
		...
		<div class="table1_list">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-bordered table-hover edison-table" style="table-layout:fixed;">
				...
				<tr>
					...
					<td>
						<input type="text" class="form-control" name="<portlet:namespace/>surveyTitle" size="50" maxlength="150" value="${surveyMap.surveyTitle}" style="width: auto;"/>
					</td>
		...
		<c:forEach var="data" items="${surveyQuestionList}" varStatus="status">
			<div id="<portlet:namespace/>survey_${status.index+1}" class="table1_list" style="border-top: 0px;">
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="survey table table-bordered table-hover edison-table"  style="table-layout:fixed; margin-top:20px; border-top: 1px solid gray;">
					<colgroup>
						<col width="12%" />
						<col width="8%" />
						<col width="35%" />
					...
					<c:choose>
						 <c:when test="${data.questionDivCd =='SVY_02_001'}">
							 <tr class="question_title" data-questionSeq="-${data.questionSeqNo}">
								...
								<td>
									<input type="text" name="<portlet:namespace/>questionTitle-${data.questionSeqNo}" size="50" maxlength="150" value="${data.questionTitle}" style="width: auto;" class="form-control"/>
								</td>
							...
							<tr class="question">
								...
								<td colspan="2">
									<input type="text" class="form-control" name="<portlet:namespace/>question-${data.questionSeqNo}" maxlength="256" value="${data.question1}" style="width: 600px;"/>
								</td>
								<td>
							...
							<tr class="question">
								...
								<td colspan="2">
									<input type="text" class="form-control" name="<portlet:namespace/>question-${data.questionSeqNo}" maxlength="256" value="${data.question2}"  style="width: 600px;"/>
								</td>
								<td>
							...
							<tr class="question">
								...
								<td colspan="2">
									<input type="text" class="form-control" name="<portlet:namespace/>question-${data.questionSeqNo}" maxlength="256" value="${data.question3}" style="width: 600px;"/>
								</td>
								<td>
							...
							<tr class="question">
								...
								<td colspan="2">
									<input type="text" class="form-control" name="<portlet:namespace/>question-${data.questionSeqNo}" maxlength="256" value="${data.question4}" style="width: 600px;"/>
								</td>
								<td>
							...
							<tr class="question">
								...
								<td colspan="2">
									<input type="text" class="form-control" name="<portlet:namespace/>question-${data.questionSeqNo}" maxlength="256" value="${data.question5}" style="width: 600px;"/>
								</td>
								<td>
							...
							<tr class="question">
								...
								<td colspan="2">
									<input type="text" class="form-control" name="<portlet:namespace/>question-${data.questionSeqNo}" maxlength="256" value="${data.question6}" style="width: 600px;"/>
								</td>
								<td>
							...
							<tr class="question">
								...
								<td colspan="2">
									<input type="text" class="form-control" name="<portlet:namespace/>question-${data.questionSeqNo}" maxlength="256" value="${data.question7}" style="width: 600px;"/>
								</td>
								<td>
							...
							<tr class="question">
								...
								<td colspan="2">
									<input type="text" class="form-control" name="<portlet:namespace/>question-${data.questionSeqNo}" maxlength="256" value="${data.question8}" style="width: 600px;"/>
								</td>
								<td>
							...
							<tr class="question">
								...
								<td colspan="2">
									<input type="text" class="form-control" name="<portlet:namespace/>question-${data.questionSeqNo}" maxlength="256" value="${data.question9}" style="width: 600px;"/>
								</td>
								<td>
							...
							<tr class="question">
								...
								<td colspan="2">
									<input type="text" class="form-control" name="<portlet:namespace/>question-${data.questionSeqNo}" maxlength="256" value="${data.question10}" style="width: 600px;"/>
								</td>
								<td>
						 ...
						 <c:otherwise>
							 <tr class="question_title" data-questionSeq="-${data.questionSeqNo}">
								...
								<th><liferay-ui:message key='edison-virtuallab-surveyResultList-question-title' /></th>
								<td>
									<input type="text" class="form-control" name="<portlet:namespace/>questionTitle-${data.questionSeqNo}" size="50" maxlength="256" value="${data.questionTitle}" style="width: auto"/>
								</td>
								<th><liferay-ui:message key='edison-virtuallab-surveyResultList-answer-type' /></th>
								<td>
									<div style="display:block;">
	...
	<div style="text-align: right; margin-top: 10px;">
		<c:if test="${answerCnt != '0'}">
			...
			<input class="btn btn-default" type="button" onclick="historyback()" value="<liferay-ui:message key='edison-button-board-list' />" />
		<c:if test="${answerCnt == '0'}">
			<input class="btn btn-default" type="button" onclick="onclickConfirm()" value="<liferay-ui:message key='edison-button-board-modify' />" />
			<input class="btn btn-default" type="button" onclick="fnDelete()" value="<liferay-ui:message key='edison-button-board-delete' />" />
		</c:if>
	</div>
</form>
