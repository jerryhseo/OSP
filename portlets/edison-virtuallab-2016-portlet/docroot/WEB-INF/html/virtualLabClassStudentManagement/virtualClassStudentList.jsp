			...
			if(virtualClassStudentList === undefined || virtualClassStudentList.length == 0) {
				...
				for(var i = 0; i < virtualClassStudentList.length; i++) {
					...
					if(virtualClassStudentList[i].requestSort == "REQUEST") {
						...
						$("<td/>").html("<liferay-ui:message key='edison-virtuallab-virtualLabClassRegistrationList-take-class' />")
								  .css("text-align","center")
								  .appendTo($rowResult);
						...
						$("<td/>").html("<liferay-ui:message key='edison-virtuallab-denial' />")
								  .css("text-align","center")
								  .appendTo($rowResult);
...
function studentDelete(userScreenName, virtualLabUserId){
	if(confirm("<liferay-ui:message key='edison-virtuallab-virtualClassStudent-student-delete-alert' />")){
