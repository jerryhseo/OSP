...
<%
	...
	if(clickTab.equals("favoriteApp")){
		...
		jspFile = "edisonfilemanager_WAR_edisonsimulationportlet";
	}else if(clickTab.equals("mySimulationFile")){
		jspFile = "edisontreeviewmonitoring_WAR_edisonsimulationportlet";
