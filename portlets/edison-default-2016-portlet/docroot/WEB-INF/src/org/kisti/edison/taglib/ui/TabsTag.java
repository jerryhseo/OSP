...
package org.kisti.edison.taglib.ui;
...
public class TabsTag extends IncludeTag {
	...
	public int doEndTag() throws JspException {
		try {
			...
			request.removeAttribute("liferay-ui:tabs:minwidth");
			return EVAL_PAGE;
		}
		catch (Exception e) {
	...
	public int doStartTag() throws JspException {
		try {
			...
			if (_minwidth != 0) {
				request.setAttribute("liferay-ui:tabs:minwidth", _minwidth);
			}
	...
	private static final String _START_PAGE = "/html/taglib/ui/edisontabs/start.jsp";
