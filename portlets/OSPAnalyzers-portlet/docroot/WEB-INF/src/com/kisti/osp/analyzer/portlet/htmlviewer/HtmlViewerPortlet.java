...
/**
 * Portlet implementation class HtmlViewerPortlet
 */
public class HtmlViewerPortlet extends MVCPortlet {
	private static Log _log = LogFactoryUtil.getLog(HtmlViewerPortlet.class);
    ...
    public void serveResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
        ...
        if(command.equalsIgnoreCase("READ_FILE")){
            ...
            // TODO : getCopiedTemporaryFilePath
            String result;
            try{
                result = FileManagementLocalServiceUtil.getCopiedTemporaryFilePath(resourceRequest, parentPath, "", ".tmp", true);
            }catch (PortalException | SystemException e){
