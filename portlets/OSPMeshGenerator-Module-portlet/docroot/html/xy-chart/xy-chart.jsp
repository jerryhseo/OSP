...
<html>
  ...
  <body ng-app="app" ng-controller="appCtrl">
    ...
    <script src="${pageContext.request.contextPath}/js/xy-chart/highcharts.js"></script>
    <script src="${pageContext.request.contextPath}/js/xy-chart/highcharts-3d.js"></script>
    <script src="${pageContext.request.contextPath}/js/xy-chart/highcharts-more.js"></script>
    <script src="${pageContext.request.contextPath}/js/xy-chart/exporting.js"></script>
    <script src="${pageContext.request.contextPath}/js/xy-chart/map.js"></script>
    <script src="${pageContext.request.contextPath}/js/xy-chart/data.js"></script>
    <script src="${pageContext.request.contextPath}/js/xy-chart/highcharts-contour.js"></script>
    <script src="${pageContext.request.contextPath}/js/xy-chart/delaunay.js"></script>

    <!-- build:js(.) scripts/vendor.js -->
    

	<!-- TODO -->
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/xy-chart/jquery-ui.min.js"></script>	<!-- Modified Link -->
