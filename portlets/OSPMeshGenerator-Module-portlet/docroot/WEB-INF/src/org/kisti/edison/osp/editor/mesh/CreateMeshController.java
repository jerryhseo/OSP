...
public class CreateMeshController {
	...
	public void saveMesh(
		...
		try{
			...
			AnalyzerJob analyzerJob = meshAppHelper.prepareAnalyzer(appName, appVersion, user.getScreenName());
			...
			String workingPath = meshAppHelper.createInputFiles(projectId, fileList, themeDisplay, analyzerJob, user);
			
			String sdeFilePath = workingPath+File.separator+sdeFileName;
			
			boolean isComplete = meshAppHelper.exeKflowMeshAnalyzer(projectId, datFilePath, sdeFilePath, themeDisplay, analyzerJob, user);
