...
public interface ChildChallengeService extends BaseService, InvokableService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ChildChallengeServiceUtil} to access the child challenge remote service. Add custom service methods to {@link kisti.edison.challenge.service.impl.ChildChallengeServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
