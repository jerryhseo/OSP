 ...
 * @generated
 */
public class ChallengeTeamExportActionableDynamicQuery
	extends ChallengeTeamActionableDynamicQuery {
	public ChallengeTeamExportActionableDynamicQuery(
	...
	protected void addCriteria(DynamicQuery dynamicQuery) {
		...
		if (_portletDataContext.isInitialPublication()) {
			...
			StagedModelDataHandler<?> stagedModelDataHandler = StagedModelDataHandlerRegistryUtil.getStagedModelDataHandler(ChallengeTeam.class.getName());
	...
	protected void performAction(Object object)
		...
		ChallengeTeam stagedModel = (ChallengeTeam)object;
