 ...
 * @generated
 */
public class ChildChallengeExportActionableDynamicQuery
	extends ChildChallengeActionableDynamicQuery {
	public ChildChallengeExportActionableDynamicQuery(
	...
	protected void addCriteria(DynamicQuery dynamicQuery) {
		...
		if (_portletDataContext.isInitialPublication()) {
			...
			StagedModelDataHandler<?> stagedModelDataHandler = StagedModelDataHandlerRegistryUtil.getStagedModelDataHandler(ChildChallenge.class.getName());
	...
	protected void performAction(Object object)
		...
		ChildChallenge stagedModel = (ChildChallenge)object;
