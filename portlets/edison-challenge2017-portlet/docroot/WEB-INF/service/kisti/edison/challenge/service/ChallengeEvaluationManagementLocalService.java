...
/**
 * Provides the local service interface for ChallengeEvaluationManagement. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author KYJ
 * @see ChallengeEvaluationManagementLocalServiceUtil
...
public interface ChallengeEvaluationManagementLocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ChallengeEvaluationManagementLocalServiceUtil} to access the challenge evaluation management local service. Add custom service methods to {@link kisti.edison.challenge.service.impl.ChallengeEvaluationManagementLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
