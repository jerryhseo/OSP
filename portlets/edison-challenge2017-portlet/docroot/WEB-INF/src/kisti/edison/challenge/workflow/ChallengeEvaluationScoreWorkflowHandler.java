...
public class ChallengeEvaluationScoreWorkflowHandler extends BaseWorkflowHandler{
	@Override
	...
	public Object updateStatus(int status, Map<String, Serializable> workflowContext) throws PortalException, SystemException {
		...
		long challengeEvaluationScoreId = GetterUtil.getLong(
	    		(String)workflowContext.get(WorkflowConstants.CONTEXT_ENTRY_CLASS_PK));
		
		ServiceContext serviceContext = (ServiceContext)workflowContext.get("serviceContext");
		
		
		return ChallengeEvaluationScoreLocalServiceUtil.updateStatus(userId, challengeEvaluationScoreId, status, serviceContext);
	}
