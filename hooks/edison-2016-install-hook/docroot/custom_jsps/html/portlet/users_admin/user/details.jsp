...
<script src="/edison-2016-install-hook/js/jquery-1.10.2.min.js"></script>
<%
...
if(selUser != null){
	...
	OrderByComparator tableClassIdSearch = (OrderByComparator)PortletBeanLocatorUtil.locate("edison-2016-install-hook","hookExpandoUtil");
