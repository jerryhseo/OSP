...
/**
 * The persistence utility for the system properties service. This utility wraps {@link SystemPropertiesPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class SystemPropertiesUtil {
	 ...
	 */
	public static void clearCache(SystemProperties systemProperties) {
		getPersistence().clearCache(systemProperties);
	}
	 ...
	 */
	public static List<SystemProperties> findWithDynamicQuery(
	...
	public static SystemProperties update(SystemProperties systemProperties)
		throws SystemException {
		return getPersistence().update(systemProperties);
	}
	...
	public static SystemProperties update(SystemProperties systemProperties,
		...
		return getPersistence().update(systemProperties, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(systemProperties);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(systemPropertieses);
	}
	...
	*/
	public static com.kisti.osp.model.SystemProperties create(
	...
	*/
	public static com.kisti.osp.model.SystemProperties remove(
		java.lang.String propertyName)
	...
	public static com.kisti.osp.model.SystemProperties updateImpl(
		com.kisti.osp.model.SystemProperties systemProperties)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(systemProperties);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.kisti.osp.model.SystemProperties findByPrimaryKey(
		java.lang.String propertyName)
		throws com.kisti.osp.NoSuchSystemPropertiesException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.kisti.osp.model.SystemProperties fetchByPrimaryKey(
		java.lang.String propertyName)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.kisti.osp.model.SystemProperties> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static SystemPropertiesPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (SystemPropertiesPersistence)PortletBeanLocatorUtil.locate(com.kisti.osp.service.ClpSerializer.getServletContextName(),
					SystemPropertiesPersistence.class.getName());

			ReferenceRegistry.registerReference(SystemPropertiesUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(SystemPropertiesPersistence persistence) {
	}

	private static SystemPropertiesPersistence _persistence;
}