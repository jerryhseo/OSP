...
/**
 * Provides the local service interface for SystemProperties. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Jerry h. Seo
 * @see SystemPropertiesLocalServiceUtil
...
public interface SystemPropertiesLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SystemPropertiesLocalServiceUtil} to access the system properties local service. Add custom service methods to {@link com.kisti.osp.service.impl.SystemPropertiesLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
